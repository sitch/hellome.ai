...
// Source: https://app.freeprivacypolicy.com/download/0685b448-7069-4a37-bfb4-22aaed8d2e84
// Reference: https://tailwindui.com/privacy-policy
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Michael Sitchenko, New York NY
                10009.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to HelloMe.ai, accessible from{' '}
                <a
                  href="https://hellome.ai"
          ...
          <ul>
            <li>
              ...
              <a
                href="https://hellome.ai/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://hellome.ai/contact
              </a>
            </li>
          </ul>
        </section>
