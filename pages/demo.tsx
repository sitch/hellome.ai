...
>
          ...
          <div id="navlinks" className="invisible absolute left-0 top-full z-20 w-full origin-top-right translate-y-1 scale-90 flex-col flex-wrap justify-end gap-6 rounded-3xl border border-gray-100 bg-white p-8 opacity-0 shadow-2xl shadow-gray-600/10 transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none lg:visible lg:relative lg:flex lg:w-auto lg:translate-y-0 lg:scale-100 lg:flex-row lg:items-center lg:gap-0 lg:border-none lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:peer-checked:translate-y-0 dark:lg:bg-transparent">
            <div className="text-gray-600 dark:text-gray-300 lg:pr-4">
              <ul className="space-y-6 text-base font-medium tracking-wide lg:flex lg:space-y-0 lg:text-sm">
                <li>
                  <a href="./solution.html" className="hover:text-primary dark:hover:text-primaryLight block transition md:px-4">
                    <span>Solution</span>
                  </a>
                </li>
                <li>
                  <a href="./customers.html" className="hover:text-primary dark:hover:text-primaryLight block transition md:px-4">
                    <span>Customers</span>
                  </a>
                </li>
                <li>
                  <a href="./pricing.html" className="hover:text-primary dark:hover:text-primaryLight block transition md:px-4">
                    <span>Pricing</span>
                  </a>
                </li>
                <li>
                  <a href="./blog.html" className="hover:text-primary dark:hover:text-primaryLight block transition md:px-4">
                    <span>Blog</span>
                  </a>
                </li>
                <li>
                  <a href="./about.html" className="hover:text-primary dark:hover:text-primaryLight block transition md:px-4">
                    <span>Company</span>
                  </a>
                </li>
              </ul>
            ...
            <div className="border-primary/10 -ml-1 mt-12 flex w-full flex-col space-y-2 dark:border-gray-700 sm:flex-row md:w-max lg:mr-6 lg:mt-0 lg:space-y-0 lg:border-l lg:pl-6">
              <a href="./contact.html" className="before:bg-primary dark:before:bg-primaryLight relative ml-auto flex h-9 w-full items-center justify-center before:absolute before:inset-0 before:rounded-full before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 sm:px-4 lg:before:border lg:before:border-gray-200 lg:before:bg-gray-100 lg:dark:before:bg-gray-800">
                <span className="lg:text-primary relative text-sm font-semibold text-white dark:text-gray-900 lg:dark:text-white">Get started</span>
              </a>
            </div>
  ...
  <section className="relative">
    ...
    <div className="mx-auto px-4 pt-32 sm:px-12 sm:pt-40 md:pt-48 lg:pt-56 xl:max-w-6xl xl:px-0">
        ...
        <div className="flex flex-col">
          <h1 className="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl md:text-left lg:text-7xl">
            ...
            <span className="relative">
              ...
              <span className="relative text-blue-800 dark:text-white md:px-2">Scale</span>
            </span>
          </h1>
      ...
      <div className="relative -mx-4 mt-16 flex snap-x snap-mandatory justify-between gap-6 overflow-x-auto border-y border-gray-100 px-4 py-8 dark:border-gray-800 sm:-mx-12 sm:px-12 lg:mx-0 lg:px-0">
        <div className="snap-center text-center sm:text-left">
          <div className="border-primary/20 shadow-primary/10 mx-auto mb-4 flex h-12 w-12 rounded-xl border bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 sm:ml-0 sm:mr-auto">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-primary m-auto h-6 w-6 dark:text-blue-300">
      ...
      <div className="my-8 flex justify-between gap-6 brightness-75 contrast-200 grayscale dark:brightness-200 dark:contrast-0 md:my-16 lg:gap-12">
        <img src="./../images/clients/airbnb.svg" className="h-8 w-auto dark:brightness-200 sm:h-10 lg:h-12" alt="airbnb" width height />
        <img src="./../images/clients/ge.svg" className="h-8 w-auto dark:brightness-200 sm:h-10 lg:h-12" alt="ge" width height />
        <img src="./../images/clients/coty.svg" className="h-8 w-auto dark:brightness-0 dark:contrast-0 sm:h-10 lg:h-12" alt="coty" width height />
        <img src="./../images/clients/microsoft.svg" className="h-8 w-auto dark:brightness-200 sm:h-10 lg:h-12" alt="microsoft" width height />
      </div>
    </div>
  </section>
    ...
    <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      <div className="items-center justify-center space-y-6 md:flex md:gap-6 md:space-y-0">
        <div className="md:w-1/2 lg:w-3/5">
          <img className="h-full rounded-3xl object-cover md:-ml-8" src="./../images/mission.webp" alt="working woman" loading="lazy" width={1399} height={1314} />
        </div>
        <div className="md:w-1/2">
          <span className="text-primary dark:text-secondaryLight text-sm font-semibold uppercase tracking-widest">Mission</span>
          <h2 className="my-8 text-4xl font-bold text-gray-900 dark:text-white lg:text-5xl">
            Help great teams become
            <span className="from-primaryLight to-secondaryLight bg-gradient-to-r bg-clip-text text-transparent">dream teams</span>
          </h2>
  ...
  <svg aria-hidden="true" className="dark:text-darker text-gray-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    <path fill="currentColor" fillOpacity={1} d="M0,160L48,181.3C96,203,192,245,288,234.7C384,224,480,160,576,133.3C672,107,768,117,864,138.7C960,160,1056,192,1152,224C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" />
  </svg>
  <section className="dark:bg-darker relative bg-gray-100 pt-16 sm:pt-8 md:py-0">
    <div className="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white md:text-4xl xl:text-5xl">
          We<span className="from-primaryLight to-secondaryLight dark:from-secondary relative bg-gradient-to-r bg-clip-text px-2 text-transparent dark:to-purple-300">Scaled !</span>
        </h2>
      ...
      <div className="relative mt-32 hidden h-40 w-40 items-center justify-center lg:mx-auto lg:flex">
        <div className="it absolute inset-0 flex flex-wrap blur-3xl">
          <div aria-hidden="true" className="bg-primary h-1/2 w-1/2 rounded-tl-full" />
          <div aria-hidden="true" className="h-1/2 w-1/2 rounded-tr-full bg-purple-700" />
          <div aria-hidden="true" className="bg-secondary h-1/2 w-1/2 rounded-bl-full" />
          <div aria-hidden="true" className="bg-secondaryLight h-1/2 w-1/2 rounded-br-full" />
        </div>
        ...
        <div className="relative py-32 before:absolute before:inset-0 before:mx-auto before:h-full before:w-px after:absolute after:inset-0 after:h-32 after:w-px after:bg-gradient-to-t after:from-gray-900/20 after:via-gray-200 after:before:to-gray-900 dark:after:from-white/20 dark:after:via-gray-800 lg:before:bg-gray-200 lg:after:mx-auto lg:after:bg-gradient-to-b lg:dark:before:bg-gray-900">
          <div className="relative flex flex-col items-center gap-10 pb-12 pl-6 before:absolute before:inset-0 before:h-1/2 before:w-px before:bg-gradient-to-b before:from-gray-400/70 before:to-gray-400/70 after:absolute after:inset-x-0 after:bottom-0 after:h-1/2 after:w-px after:border-r after:border-dashed after:border-gray-400/70 dark:before:from-gray-700 dark:before:to-gray-700 dark:after:border-gray-700 sm:pl-12 md:flex-row md:pb-20 lg:pl-0 lg:before:left-[9.1rem] lg:before:from-transparent lg:before:to-gray-400/70 lg:after:left-[9.1rem] dark:lg:before:from-transparent dark:lg:before:to-gray-700">
            <div className="flex w-full flex-col gap-10 md:w-1/2 lg:flex-row lg:items-center">
              <div className="hidden w-max md:block">
                <div className="h-24 w-24 rounded-full border border-gray-200 bg-white p-4 shadow-xl shadow-gray-600/10 dark:border-gray-800 dark:bg-gray-900 dark:shadow-none">
                  <img className="h-full w-full rounded-full object-cover object-top" src="./../images/avatars/avatar.webp" alt="user avatar" loading="lazy" width={400} height={400} />
                </div>
              </div>
              <div aria-hidden="true" className="absolute -left-2.5 top-[1.80rem] z-[1] my-auto h-max w-max md:inset-y-0 lg:relative lg:-mr-2.5 lg:ml-2.5">
                <div className="bg-primary dark:border-darker h-5 w-5 rounded-full border-8 border-white ring-1 ring-gray-400/70 dark:bg-white dark:ring-gray-700" />
              </div>
              <div className>
            ...
            <div className="w-full md:w-1/2">
              <img className="h-56 w-full rounded-2xl object-cover md:h-80" src="./../images/steps/step1.webp" alt="timeline first step" loading="lazy" width={1165} height={864} />
            </div>
          </div>
          <div className="flex items-center gap-6">
            <div aria-hidden="true" className="my-3.5 -ml-8 h-16 w-16 rotate-45 rounded-bl-full rounded-tr-3xl border border-dashed border-gray-400/70 dark:border-gray-700 lg:ml-[7.15rem]" />
            <span className="text-gray-700 dark:text-white">12 Satisfied
              <a href="customers.html" className="text-primary dark:text-primaryLight underline">Customers</a>
              !</span>
          </div>
          <div className="relative flex flex-col items-center gap-10 py-12 pl-6 after:absolute after:inset-0 after:h-full after:w-px after:border-r after:border-dashed after:border-gray-400/70 dark:after:border-gray-700 sm:pl-12 md:flex-row md:py-20 lg:pl-0 lg:after:left-[9.1rem]">
            <div className="flex w-full flex-col gap-10 md:w-1/2 lg:flex-row lg:items-center">
              ...
              <div aria-hidden="true" className="absolute -left-2.5 top-[4.80rem] z-[1] my-auto h-max w-max md:inset-y-0 lg:relative lg:-mr-2.5 lg:ml-2.5">
                <div className="dark:border-darker h-5 w-5 rounded-full border-8 border-white bg-purple-600 ring-1 ring-gray-400/70 dark:bg-white dark:ring-gray-700" />
              </div>
              <div className>
            ...
            <div className="w-full md:w-1/2">
              <img className="h-56 w-full rounded-2xl object-cover md:h-80" src="./../images/steps/step2.webp" alt="timeline first step" loading="lazy" width={1165} height={864} />
            </div>
          </div>
          <div className="flex items-center gap-6">
            ...
            <div>
              <span className="text-gray-700 dark:text-white">5 Developers joined the
                <a href="customers.html" className="text-primary dark:text-primaryLight underline">Team</a>
                !</span>
              <div className="children:h-10 children:w-10 children:rounded-full children:object-cover children:ring-4 children:ring-gray-100 dark:children:ring-darker mt-5 flex -space-x-1">
                <img src="./../images/avatars/avatar-1.webp" alt="user avatar" loading="lazy" width={200} height={200} />
                <img src="./../images/avatars/avatar-2.webp" alt="user avatar" loading="lazy" width={200} height={200} />
                <img src="./../images/avatars/avatar-3.webp" alt="user avatar" loading="lazy" width={200} height={200} />
                <img src="./../images/avatars/avatar-4.webp" alt="user avatar" loading="lazy" width={200} height={200} />
                <img src="./../images/avatars/avatar.webp" alt="user avatar" loading="lazy" width={400} height={400} />
              </div>
            </div>
          </div>
          <div className="relative flex flex-col items-center gap-10 py-12 pl-6 after:absolute after:inset-0 after:h-full after:w-px after:border-r after:border-dashed after:border-gray-400/70 dark:after:border-gray-700 sm:pl-12 md:flex-row md:py-20 lg:pl-0 lg:after:left-[9.1rem]">
            <div className="flex w-full flex-col gap-10 md:w-1/2 lg:flex-row lg:items-center">
              <div className="hidden w-max md:block">
                <div className="flex h-24 w-24 rounded-full border border-gray-200 bg-white p-4 shadow-xl shadow-gray-600/10 dark:border-gray-800 dark:bg-gray-900 dark:shadow-none">
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-primary m-auto h-6 w-6 dark:text-blue-300">
                    <path className="text-primaryLight" fillRule="evenodd" d="M7.5 5.25a3 3 0 013-3h3a3 3 0 013 3v.205c.933.085 1.857.197 2.774.334 1.454.218 2.476 1.483 2.476 2.917v3.033c0 1.211-.734 2.352-1.936 2.752A24.726 24.726 0 0112 15.75c-2.73 0-5.357-.442-7.814-1.259-1.202-.4-1.936-1.541-1.936-2.752V8.706c0-1.434 1.022-2.7 2.476-2.917A48.814 48.814 0 017.5 5.455V5.25zm7.5 0v.09a49.488 49.488 0 00-6 0v-.09a1.5 1.5 0 011.5-1.5h3a1.5 1.5 0 011.5 1.5zm-3 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z" clipRule="evenodd" />
                    <path d="M3 18.4v-2.796a4.3 4.3 0 00.713.31A26.226 26.226 0 0012 17.25c2.892 0 5.68-.468 8.287-1.335.252-.084.49-.189.713-.311V18.4c0 1.452-1.047 2.728-2.523 2.923-2.12.282-4.282.427-6.477.427a49.19 49.19 0 01-6.477-.427C4.047 21.128 3 19.852 3 18.4z" />
                  </svg>
                </div>
            ...
            <div className="w-full md:w-1/2">
              <img className="h-56 w-full rounded-2xl object-cover md:h-80" src="./../images/steps/step3.webp" alt="timeline third step" loading="lazy" width={1165} height={864} />
            </div>
          </div>
          <div className="flex items-center gap-6">
            <div aria-hidden="true" className="my-3.5 -ml-8 h-16 w-16 rotate-45 rounded-bl-full rounded-tr-3xl border border-dashed border-gray-400/70 dark:border-gray-700 lg:ml-[7.15rem]" />
            <div className="w-10/12">
              <span className="text-gray-700 dark:text-white">Worked with 5 world leading
                <a href="customers.html" className="text-primary dark:text-primaryLight underline">companies</a>
                !</span>
              <div className="mt-5 flex w-full justify-between gap-6 brightness-200 contrast-0 grayscale lg:gap-x-24">
                <img className="h-8 w-auto md:h-10 lg:w-auto" src="./../images/clients/airbnb.svg" loading="lazy" alt="airbnb" width height />
                <img className="h-8 w-auto md:h-10 lg:w-auto" src="./../images/clients/coty.svg" loading="lazy" alt="coty" width height />
                <img className="h-8 w-auto md:h-10 lg:w-auto" src="./../images/clients/ge.svg" loading="lazy" alt="ge" width height />
                <img className="hidden h-8 w-auto sm:block md:h-10 lg:w-auto" src="./../images/clients/lilly.png" loading="lazy" alt="lilly" width height />
                <img className="hidden h-8 w-auto sm:block md:h-10 lg:w-auto" src="./../images/clients/microsoft.svg" loading="lazy" alt="microsoft" width height />
              </div>
            </div>
          </div>
          <div className="relative flex flex-col items-center gap-10 py-12 pl-6 before:absolute before:inset-x-0 before:bottom-0 before:h-1/2 before:w-px before:bg-gradient-to-t before:from-transparent before:to-gray-400/70 after:absolute after:inset-0 after:top-0 after:h-1/2 after:w-px after:border-r after:border-dashed after:border-gray-400/70 dark:before:to-gray-700 dark:after:border-gray-700 sm:pl-12 md:flex-row md:py-20 lg:pl-0 lg:before:left-[9.1rem] lg:after:left-[9.1rem]">
            <div className="flex w-full flex-col gap-10 md:w-1/2 lg:flex-row lg:items-center">
              ...
              <div className="absolute -left-2.5 top-[4.80rem] z-[1] my-auto h-max w-max md:inset-y-0 lg:relative lg:-mr-2.5 lg:ml-2.5">
                <div className="dark:border-darker h-5 w-5 rounded-full border-8 border-white bg-yellow-600 ring-1 ring-gray-400/70 dark:bg-white dark:ring-gray-700" />
              </div>
              <div className>
            ...
            <div className="w-full md:w-1/2">
              <img className="h-56 w-full rounded-2xl object-cover md:h-80" src="./../images/steps/step4.webp" alt="timeline fourth step" loading="lazy" width={1165} height={864} />
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="dark:from-darker bg-gradient-to-b from-gray-100 to-transparent pt-20">
    <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      ...
      <div className="mt-20">
        <div className="mx-auto flex flex-wrap justify-center gap-x-6 gap-y-16 sm:grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
          <div>
            <img src="./../images/team/member1.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
              <span className="mt-4 block text-gray-500 dark:text-gray-300">CEO - Founder</span>
              <span className="text-gray-500">Also founded :
              ...
              <div className="mt-6 flex items-center gap-4">
                <a href="#" target="_blank" aria-label="twitter" className="hover:text-primary dark:hover:text-primaryLight text-gray-600 dark:text-gray-400">
                ...
                <a href="#" target="_blank" aria-label="instagram" className="hover:text-primary dark:hover:text-primaryLight text-gray-600 dark:text-gray-400">
                ...
                <a href="#" target="_blank" aria-label="facebook" className="hover:text-primary dark:hover:text-primaryLight text-gray-600 dark:text-gray-400">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4" viewBox="0 0 16 16">
          ...
          <div>
            <img src="./../images/team/member2.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
          ...
          <div>
            <img src="./../images/team/member3.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
          ...
          <div>
            <img src="./../images/team/member4.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
          ...
          <div>
            <img src="./../images/team/member5.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
          ...
          <div>
            <img src="./../images/team/member6.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
          ...
          <div>
            <img src="./../images/team/member7.webp" alt="team member" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={267} height={267} />
            <div className="mt-4">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                Hentoni Doe
              </h3>
    ...
    <div className="container m-auto px-6 text-center md:px-12 lg:px-20">
      <div className="relative mx-auto flex h-56 w-56 items-center justify-center">
        <div className="it absolute inset-0 flex flex-wrap opacity-40 blur-3xl dark:opacity-70">
          <div aria-hidden="true" className="bg-primary h-1/2 w-1/2" />
      ...
      <div className="relative -mt-12">
        ...
        <a href="contact.html" className="before:bg-primary dark:before:bg-primaryLight relative mx-auto flex h-11 w-max items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:transition-transform before:duration-300 active:duration-75 active:before:scale-95">
          ...
          <div className="col-span-8 md:col-span-2 lg:col-span-3">
            <div className="flex h-full items-center justify-between gap-6 border-b border-white py-6 dark:border-gray-800 md:flex-col md:items-start md:justify-between md:space-y-6 md:border-none md:py-0">
              <div>
                ...
                <a href="https://tailus.io" className="mt-2 inline-block text-sm">Designed by Tailus in Lubumbashi
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
              <div>
                ...
                <ul className="mt-4 list-inside space-y-4">
                  <li>
                    <a href="#" className="hover:text-primary text-sm duration-100 dark:hover:text-white">About</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-primary text-sm duration-100 dark:hover:text-white">Customers</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-primary text-sm duration-100 dark:hover:text-white">Enterprise</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-primary text-sm duration-100 dark:hover:text-white">Partners</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-primary text-sm duration-100 dark:hover:text-white">Jobs</a>
                  </li>
                </ul>
              </div>
              <div>
  ...
  return (
    <>
      <main className="bg-red container mx-auto">
        <section className=" bg-green">Section 1</section>
      </main>
    </>
  )
}
