...
photo: "/mdx/articles/hello-world/og_article_1200x1200.png"
...
It also includes a JavaScript file that enables interactive components, such as modals, dropdowns, and date pickers which you can optionally include into your project via CDN or NPM.
