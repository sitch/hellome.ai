...
const Schema: z.ZodType<Prisma.PageArtworkCreateNestedManyWithoutStoryInput> = z
  .object({
    create: z
      .union([
...
export const PageArtworkCreateNestedManyWithoutStoryInputObjectSchema = Schema
