...
const Schema: z.ZodType<Prisma.ConceptCreateWithoutDreamboothTrainingInput> = z
  .object({
...
export const ConceptCreateWithoutDreamboothTrainingInputObjectSchema = Schema
