...
const Schema: z.ZodType<Prisma.ConceptUncheckedUpdateWithoutDreamboothTrainingInput> =
  z
    .object({
      id: z
        .union([
...
export const ConceptUncheckedUpdateWithoutDreamboothTrainingInputObjectSchema =
  Schema
