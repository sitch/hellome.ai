...
const Schema: z.ZodType<Prisma.ConceptUncheckedCreateWithoutDreamboothTrainingInput> =
  z
    .object({
...
export const ConceptUncheckedCreateWithoutDreamboothTrainingInputObjectSchema =
  Schema
