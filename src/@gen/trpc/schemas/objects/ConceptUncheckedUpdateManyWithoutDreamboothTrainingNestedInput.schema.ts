...
const Schema: z.ZodType<Prisma.ConceptUncheckedUpdateManyWithoutDreamboothTrainingNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      createMany: z
        .lazy(
          () => ConceptCreateManyDreamboothTrainingInputEnvelopeObjectSchema,
        )
        .optional(),
      set: z
        .union([
...
export const ConceptUncheckedUpdateManyWithoutDreamboothTrainingNestedInputObjectSchema =
  Schema
