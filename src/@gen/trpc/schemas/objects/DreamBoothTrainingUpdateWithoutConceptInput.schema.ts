...
const Schema: z.ZodType<Prisma.DreamBoothTrainingUpdateWithoutConceptInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const DreamBoothTrainingUpdateWithoutConceptInputObjectSchema = Schema
