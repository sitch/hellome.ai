...
export const pagetextsRouter = t.router({
  aggregatePageText: shieldedProcedure
    .input(PageTextAggregateSchema).query(async ({ ctx, input }) => {
  ...
  createManyPageText: shieldedProcedure
    .input(PageTextCreateManySchema).mutation(async ({ ctx, input }) => {
  ...
  createOnePageText: shieldedProcedure
    .input(PageTextCreateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  deleteManyPageText: shieldedProcedure
    .input(PageTextDeleteManySchema).mutation(async ({ ctx, input }) => {
  ...
  deleteOnePageText: shieldedProcedure
    .input(PageTextDeleteOneSchema).mutation(async ({ ctx, input }) => {
  ...
  findFirstPageText: shieldedProcedure
    .input(PageTextFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findFirstPageTextOrThrow: shieldedProcedure
    .input(PageTextFindFirstSchema).query(async ({ ctx, input }) => {
      const findFirstPageTextOrThrow = await ctx.prisma.pageText.findFirstOrThrow(input);
      return findFirstPageTextOrThrow;
    }),
  findManyPageText: shieldedProcedure
    .input(PageTextFindManySchema).query(async ({ ctx, input }) => {
  ...
  findUniquePageText: shieldedProcedure
    .input(PageTextFindUniqueSchema).query(async ({ ctx, input }) => {
  ...
  findUniquePageTextOrThrow: shieldedProcedure
    .input(PageTextFindUniqueSchema).query(async ({ ctx, input }) => {
      const findUniquePageTextOrThrow = await ctx.prisma.pageText.findUniqueOrThrow(input);
      return findUniquePageTextOrThrow;
    }),
  groupByPageText: shieldedProcedure
    .input(PageTextGroupBySchema).query(async ({ ctx, input }) => {
      const groupByPageText = await ctx.prisma.pageText.groupBy({ where: input.where, orderBy: input.orderBy, by: input.by, having: input.having, take: input.take, skip: input.skip });
      return groupByPageText;
    }),
  updateManyPageText: shieldedProcedure
    .input(PageTextUpdateManySchema).mutation(async ({ ctx, input }) => {
  ...
  updateOnePageText: shieldedProcedure
    .input(PageTextUpdateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  upsertOnePageText: shieldedProcedure
    .input(PageTextUpsertSchema).mutation(async ({ ctx, input }) => {
