 ...
 * @export
 * @interface PrintJobsStatistics
 */
export interface PrintJobsStatistics {
    /**
     * Amount of printjobs
     * @type {number}
     * @memberof PrintJobsStatistics
     */
     ...
     * @memberof PrintJobsStatistics
     */
    status?: PrintJobsStatisticsStatusEnum;
}
 ...
 * @export
 */
export const PrintJobsStatisticsStatusEnum = {
    Created: 'CREATED',
    Rejected: 'REJECTED',
    Unpaid: 'UNPAID',
...
export type PrintJobsStatisticsStatusEnum = typeof PrintJobsStatisticsStatusEnum[keyof typeof PrintJobsStatisticsStatusEnum];


/**
 * Check if a given object implements the PrintJobsStatistics interface.
 */
export function instanceOfPrintJobsStatistics(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsStatisticsFromJSON(json: any): PrintJobsStatistics {
    return PrintJobsStatisticsFromJSONTyped(json, false);
}

export function PrintJobsStatisticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsStatistics {
...
export function PrintJobsStatisticsToJSON(value?: PrintJobsStatistics | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
