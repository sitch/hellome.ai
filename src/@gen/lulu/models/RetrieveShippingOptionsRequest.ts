...
import type { RetrieveShippingOptionsRequestLineItemsInner } from './RetrieveShippingOptionsRequestLineItemsInner';
import {
    RetrieveShippingOptionsRequestLineItemsInnerFromJSON,
    RetrieveShippingOptionsRequestLineItemsInnerFromJSONTyped,
    RetrieveShippingOptionsRequestLineItemsInnerToJSON,
} from './RetrieveShippingOptionsRequestLineItemsInner';
import type { RetrieveShippingOptionsRequestShippingAddress } from './RetrieveShippingOptionsRequestShippingAddress';
import {
    RetrieveShippingOptionsRequestShippingAddressFromJSON,
    RetrieveShippingOptionsRequestShippingAddressFromJSONTyped,
    RetrieveShippingOptionsRequestShippingAddressToJSON,
} from './RetrieveShippingOptionsRequestShippingAddress';

/**
 * 
 * @export
 * @interface RetrieveShippingOptionsRequest
 */
export interface RetrieveShippingOptionsRequest {
    /**
     * Currency to base cost calculations on, defaults to USD. Available currencies are AUD, CAD, EUR, GBP, and USD.
     * @type {string}
     * @memberof RetrieveShippingOptionsRequest
     */
    currency?: string;
    /**
     * The line items that should be calculated
     * @type {Array<RetrieveShippingOptionsRequestLineItemsInner>}
     * @memberof RetrieveShippingOptionsRequest
     */
    line_items: Array<RetrieveShippingOptionsRequestLineItemsInner>;
    /**
     * 
     * @type {RetrieveShippingOptionsRequestShippingAddress}
     * @memberof RetrieveShippingOptionsRequest
     */
    shipping_address: RetrieveShippingOptionsRequestShippingAddress;
}

/**
 * Check if a given object implements the RetrieveShippingOptionsRequest interface.
 */
export function instanceOfRetrieveShippingOptionsRequest(value: object): boolean {
    let isInstance = true;
...
export function RetrieveShippingOptionsRequestFromJSON(json: any): RetrieveShippingOptionsRequest {
    return RetrieveShippingOptionsRequestFromJSONTyped(json, false);
}

export function RetrieveShippingOptionsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveShippingOptionsRequest {
    ...
    return {
        ...
        'line_items': ((json['line_items'] as Array<any>).map(RetrieveShippingOptionsRequestLineItemsInnerFromJSON)),
        'shipping_address': RetrieveShippingOptionsRequestShippingAddressFromJSON(json['shipping_address']),
    };
}

export function RetrieveShippingOptionsRequestToJSON(value?: RetrieveShippingOptionsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'line_items': ((value.line_items as Array<any>).map(RetrieveShippingOptionsRequestLineItemsInnerToJSON)),
        'shipping_address': RetrieveShippingOptionsRequestShippingAddressToJSON(value.shipping_address),
    };
}
