  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.createMany(input)),
      ),
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.deleteMany(input)),
      ),
    ...
    findFirstOrThrow: procedure
      .input(UserSchema.findFirst)
      .query(({ ctx, input }) =>
        checkRead(db(ctx).user.findFirstOrThrow(input)),
      ),
    ...
    findUniqueOrThrow: procedure
      .input(UserSchema.findUnique)
      .query(({ ctx, input }) =>
        checkRead(db(ctx).user.findUniqueOrThrow(input)),
      ),

    groupBy: procedure
      .input(UserSchema.groupBy)
      .query(({ ctx, input }) => checkRead(db(ctx).user.groupBy(input))),

    updateMany: procedure
      .input(UserSchema.updateMany)
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.updateMany(input)),
      ),
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.upsert(input)),
      ),
  })
}
