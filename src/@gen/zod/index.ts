...
export const PageArtworkTypeSchema = z.enum([
  "machine_generated",
  "user_creative_work",
  "user_scribble",
])
...
export const EditionUpdateInputSchema: z.ZodType<Prisma.EditionUpdateInput> = z
  .object({
    ...
    updatedAt: z
      ...
      .optional(),
    user: z
      .lazy(() => UserUpdateOneRequiredWithoutEditionNestedInputSchema)
      .optional(),
    pdf: z
...
export const UserCreateNestedOneWithoutEditionInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutEditionInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => UserCreateWithoutEditionInputSchema),
          z.lazy(() => UserUncheckedCreateWithoutEditionInputSchema),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutEditionInputSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutEditionNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutEditionNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateWithoutEditionInputSchema),
          z.lazy(() => UserUncheckedUpdateWithoutEditionInputSchema),
        ])
        .optional(),
    })
    .strict()
  ...
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(() => EditionUncheckedUpdateManyWithoutEditionInputSchema),
      ]),
    })
    .strict()
...
export const UserCreateWithoutEditionInputSchema: z.ZodType<Prisma.UserCreateWithoutEditionInput> =
  z
    .object({
      id: z.string().cuid().optional(),
      name: z.string().min(1).max(160),
...
export const UserUncheckedCreateWithoutEditionInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutEditionInput> =
  z
    .object({
      id: z.string().cuid().optional(),
      name: z.string().min(1).max(160),
...
export const UserCreateOrConnectWithoutEditionInputSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutEditionInput> =
  z
    .object({
...
export const UserUpsertWithoutEditionInputSchema: z.ZodType<Prisma.UserUpsertWithoutEditionInput> =
  z
    .object({
      update: z.union([
        z.lazy(() => UserUpdateWithoutEditionInputSchema),
...
export const UserUpdateWithoutEditionInputSchema: z.ZodType<Prisma.UserUpdateWithoutEditionInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutEditionInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEditionInput> =
  z
    .object({
      id: z
        .union([
...
export const EditionUncheckedUpdateManyWithoutEditionInputSchema: z.ZodType<Prisma.EditionUncheckedUpdateManyWithoutEditionInput> =
  z
    .object({
      id: z
        .union([
