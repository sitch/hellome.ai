...
export default function DreamBoothTrainingCreate() {
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault()
    fetch("/api/dreamboothtrainings", {
      method: "POST",
      body: JSON.stringify(formState),
    }).then((res) => {
      if (res.ok) {
        alert("DreamBoothTraining created!")
        router.push("/dreamboothtrainings")
      }
    })
  }
  ...
  return (
    <>
      <header>
        <h1>Create DreamBoothTraining</h1>
      </header>
