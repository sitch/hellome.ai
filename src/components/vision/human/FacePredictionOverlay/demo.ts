...
// const width = 1920 // used by webcam config as well as human maximum resolution // can be anything, but resolutions higher than 4k will disable internal optimizations
...
// const dom = {
//   // grab instances of dom objects so we don't have to look them up later
...
//     fps.frames++
//     fps.averageMs =
//       Math.round((1000 * (human.now() - timestamp.start)) / fps.frames) / 1000
