...
export const cloudfilesRouter = t.router({
  aggregateCloudFile: shieldedProcedure
    .input(CloudFileAggregateSchema).query(async ({ ctx, input }) => {
  ...
  createManyCloudFile: shieldedProcedure
    .input(CloudFileCreateManySchema).mutation(async ({ ctx, input }) => {
  ...
  createOneCloudFile: shieldedProcedure
    .input(CloudFileCreateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  deleteManyCloudFile: shieldedProcedure
    .input(CloudFileDeleteManySchema).mutation(async ({ ctx, input }) => {
  ...
  deleteOneCloudFile: shieldedProcedure
    .input(CloudFileDeleteOneSchema).mutation(async ({ ctx, input }) => {
  ...
  findFirstCloudFile: shieldedProcedure
    .input(CloudFileFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findFirstCloudFileOrThrow: shieldedProcedure
    .input(CloudFileFindFirstSchema).query(async ({ ctx, input }) => {
      const findFirstCloudFileOrThrow = await ctx.prisma.cloudFile.findFirstOrThrow(input);
      return findFirstCloudFileOrThrow;
    }),
  findManyCloudFile: shieldedProcedure
    .input(CloudFileFindManySchema).query(async ({ ctx, input }) => {
  ...
  findUniqueCloudFile: shieldedProcedure
    .input(CloudFileFindUniqueSchema).query(async ({ ctx, input }) => {
  ...
  findUniqueCloudFileOrThrow: shieldedProcedure
    .input(CloudFileFindUniqueSchema).query(async ({ ctx, input }) => {
      const findUniqueCloudFileOrThrow = await ctx.prisma.cloudFile.findUniqueOrThrow(input);
      return findUniqueCloudFileOrThrow;
    }),
  groupByCloudFile: shieldedProcedure
    .input(CloudFileGroupBySchema).query(async ({ ctx, input }) => {
      const groupByCloudFile = await ctx.prisma.cloudFile.groupBy({ where: input.where, orderBy: input.orderBy, by: input.by, having: input.having, take: input.take, skip: input.skip });
      return groupByCloudFile;
    }),
  updateManyCloudFile: shieldedProcedure
    .input(CloudFileUpdateManySchema).mutation(async ({ ctx, input }) => {
  ...
  updateOneCloudFile: shieldedProcedure
    .input(CloudFileUpdateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  upsertOneCloudFile: shieldedProcedure
    .input(CloudFileUpsertSchema).mutation(async ({ ctx, input }) => {
