...
export const artistsRouter = t.router({
  ...
  findFirstArtistOrThrow: shieldedProcedure
    .input(ArtistFindFirstSchema)
    .query(async ({ ctx, input }) => {
      const findFirstArtistOrThrow = await ctx.prisma.artist.findFirstOrThrow(
        input
      )
  ...
  findUniqueArtistOrThrow: shieldedProcedure
    .input(ArtistFindUniqueSchema)
    .query(async ({ ctx, input }) => {
      const findUniqueArtistOrThrow = await ctx.prisma.artist.findUniqueOrThrow(
        input
      )
  ...
  groupByArtist: shieldedProcedure
    ...
    .query(async ({ ctx, input }) => {
      const groupByArtist = await ctx.prisma.artist.groupBy({
        where: input.where,
