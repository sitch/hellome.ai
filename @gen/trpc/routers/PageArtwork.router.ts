...
export const pageartworksRouter = t.router({
  aggregatePageArtwork: shieldedProcedure
    .input(PageArtworkAggregateSchema).query(async ({ ctx, input }) => {
  ...
  createManyPageArtwork: shieldedProcedure
    .input(PageArtworkCreateManySchema).mutation(async ({ ctx, input }) => {
      const createManyPageArtwork = await ctx.prisma.pageArtwork.createMany(input);
      return createManyPageArtwork;
    }),
  createOnePageArtwork: shieldedProcedure
    .input(PageArtworkCreateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  deleteManyPageArtwork: shieldedProcedure
    .input(PageArtworkDeleteManySchema).mutation(async ({ ctx, input }) => {
      const deleteManyPageArtwork = await ctx.prisma.pageArtwork.deleteMany(input);
      return deleteManyPageArtwork;
    }),
  deleteOnePageArtwork: shieldedProcedure
    .input(PageArtworkDeleteOneSchema).mutation(async ({ ctx, input }) => {
  ...
  findFirstPageArtwork: shieldedProcedure
    .input(PageArtworkFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findFirstPageArtworkOrThrow: shieldedProcedure
    .input(PageArtworkFindFirstSchema).query(async ({ ctx, input }) => {
      const findFirstPageArtworkOrThrow = await ctx.prisma.pageArtwork.findFirstOrThrow(input);
      return findFirstPageArtworkOrThrow;
    }),
  findManyPageArtwork: shieldedProcedure
    .input(PageArtworkFindManySchema).query(async ({ ctx, input }) => {
  ...
  findUniquePageArtwork: shieldedProcedure
    .input(PageArtworkFindUniqueSchema).query(async ({ ctx, input }) => {
      const findUniquePageArtwork = await ctx.prisma.pageArtwork.findUnique(input);
      return findUniquePageArtwork;
    }),
  findUniquePageArtworkOrThrow: shieldedProcedure
    .input(PageArtworkFindUniqueSchema).query(async ({ ctx, input }) => {
      const findUniquePageArtworkOrThrow = await ctx.prisma.pageArtwork.findUniqueOrThrow(input);
      return findUniquePageArtworkOrThrow;
    }),
  groupByPageArtwork: shieldedProcedure
    .input(PageArtworkGroupBySchema).query(async ({ ctx, input }) => {
      const groupByPageArtwork = await ctx.prisma.pageArtwork.groupBy({ where: input.where, orderBy: input.orderBy, by: input.by, having: input.having, take: input.take, skip: input.skip });
      return groupByPageArtwork;
    }),
  updateManyPageArtwork: shieldedProcedure
    .input(PageArtworkUpdateManySchema).mutation(async ({ ctx, input }) => {
      const updateManyPageArtwork = await ctx.prisma.pageArtwork.updateMany(input);
      return updateManyPageArtwork;
    }),
  updateOnePageArtwork: shieldedProcedure
    .input(PageArtworkUpdateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  upsertOnePageArtwork: shieldedProcedure
    .input(PageArtworkUpsertSchema).mutation(async ({ ctx, input }) => {
