...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PageArtworkUncheckedUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema
