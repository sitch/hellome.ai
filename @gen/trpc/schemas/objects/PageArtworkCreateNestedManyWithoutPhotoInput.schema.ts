...
const Schema: z.ZodType<Prisma.PageArtworkCreateNestedManyWithoutPhotoInput> = z
  .object({
    create: z
      .union([
...
export const PageArtworkCreateNestedManyWithoutPhotoInputObjectSchema = Schema
