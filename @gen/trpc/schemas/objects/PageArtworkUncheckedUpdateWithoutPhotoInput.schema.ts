...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateWithoutPhotoInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const PageArtworkUncheckedUpdateWithoutPhotoInputObjectSchema = Schema
