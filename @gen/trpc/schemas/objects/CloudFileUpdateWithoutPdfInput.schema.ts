...
import { PhotoUpdateOneWithoutFileNestedInputObjectSchema } from "./PhotoUpdateOneWithoutFileNestedInput.schema"
...
const Schema: z.ZodType<Prisma.CloudFileUpdateWithoutPdfInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    createdAt: z
      ...
      .optional(),
    photo: z
      .lazy(() => PhotoUpdateOneWithoutFileNestedInputObjectSchema)
      .optional(),
  })
  .strict()

export const CloudFileUpdateWithoutPdfInputObjectSchema = Schema
