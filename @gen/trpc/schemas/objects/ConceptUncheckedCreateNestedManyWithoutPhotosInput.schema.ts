...
const Schema: z.ZodType<Prisma.ConceptUncheckedCreateNestedManyWithoutPhotosInput> =
  z
    .object({
      create: z
        .union([
...
export const ConceptUncheckedCreateNestedManyWithoutPhotosInputObjectSchema =
  Schema
