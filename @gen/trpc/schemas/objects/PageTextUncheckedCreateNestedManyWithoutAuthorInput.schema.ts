...
const Schema: z.ZodType<Prisma.PageTextUncheckedCreateNestedManyWithoutAuthorInput> =
  z
    .object({
      create: z
        .union([
...
export const PageTextUncheckedCreateNestedManyWithoutAuthorInputObjectSchema =
  Schema
