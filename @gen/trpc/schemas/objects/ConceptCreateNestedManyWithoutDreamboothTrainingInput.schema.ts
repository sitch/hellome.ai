...
const Schema: z.ZodType<Prisma.ConceptCreateNestedManyWithoutDreamboothTrainingInput> =
  z
    .object({
      create: z
        .union([
...
export const ConceptCreateNestedManyWithoutDreamboothTrainingInputObjectSchema =
  Schema
