...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateManyWithoutPhotoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PageArtworkUncheckedUpdateManyWithoutPhotoNestedInputObjectSchema =
  Schema
