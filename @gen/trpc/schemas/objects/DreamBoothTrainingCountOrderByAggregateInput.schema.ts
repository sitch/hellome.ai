...
const Schema: z.ZodType<Prisma.DreamBoothTrainingCountOrderByAggregateInput> = z
  .object({
...
export const DreamBoothTrainingCountOrderByAggregateInputObjectSchema = Schema
