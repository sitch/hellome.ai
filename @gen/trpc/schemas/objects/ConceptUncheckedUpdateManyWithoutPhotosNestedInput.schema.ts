...
const Schema: z.ZodType<Prisma.ConceptUncheckedUpdateManyWithoutPhotosNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConceptUncheckedUpdateManyWithoutPhotosNestedInputObjectSchema =
  Schema
