...
const Schema: z.ZodType<Prisma.PageArtworkUpdateManyWithoutStoryNestedInput> = z
  .object({
    create: z
      .union([
...
export const PageArtworkUpdateManyWithoutStoryNestedInputObjectSchema = Schema
