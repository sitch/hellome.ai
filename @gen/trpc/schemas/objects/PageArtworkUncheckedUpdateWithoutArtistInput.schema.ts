...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateWithoutArtistInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const PageArtworkUncheckedUpdateWithoutArtistInputObjectSchema = Schema
