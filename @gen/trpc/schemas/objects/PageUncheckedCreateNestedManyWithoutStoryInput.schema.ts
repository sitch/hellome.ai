...
const Schema: z.ZodType<Prisma.PageUncheckedCreateNestedManyWithoutStoryInput> =
  z
    .object({
      create: z
        .union([
...
export const PageUncheckedCreateNestedManyWithoutStoryInputObjectSchema = Schema
