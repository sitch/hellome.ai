...
import { ConceptUncheckedCreateNestedManyWithoutDreamboothTrainingInputObjectSchema } from "./ConceptUncheckedCreateNestedManyWithoutDreamboothTrainingInput.schema"

const Schema: z.ZodType<Prisma.DreamBoothTrainingUncheckedCreateInput> = z
  .object({
    ...
    Concept: z
      .lazy(
        () =>
          ConceptUncheckedCreateNestedManyWithoutDreamboothTrainingInputObjectSchema,
      )
      .optional(),
  })
  .strict()

export const DreamBoothTrainingUncheckedCreateInputObjectSchema = Schema
