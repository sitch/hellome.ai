...
const Schema: z.ZodType<Prisma.ConceptUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    connectOrCreate: z
      ...
      .optional(),
    upsert: z.lazy(() => ConceptUpsertWithoutUserInputObjectSchema).optional(),
...
export const ConceptUpdateOneWithoutUserNestedInputObjectSchema = Schema
