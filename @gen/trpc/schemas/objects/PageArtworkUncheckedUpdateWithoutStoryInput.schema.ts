...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateWithoutStoryInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const PageArtworkUncheckedUpdateWithoutStoryInputObjectSchema = Schema
