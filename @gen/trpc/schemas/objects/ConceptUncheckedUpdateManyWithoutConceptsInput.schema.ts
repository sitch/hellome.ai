...
const Schema: z.ZodType<Prisma.ConceptUncheckedUpdateManyWithoutConceptsInput> =
  z
    .object({
      id: z
        .union([
...
export const ConceptUncheckedUpdateManyWithoutConceptsInputObjectSchema = Schema
