...
const Schema: z.ZodType<Prisma.PageTextUncheckedUpdateManyWithoutTextsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const PageTextUncheckedUpdateManyWithoutTextsInputObjectSchema = Schema
