...
const Schema: z.ZodType<Prisma.PageArtworkUncheckedUpdateManyWithoutPageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PageArtworkUncheckedUpdateManyWithoutPageNestedInputObjectSchema =
  Schema
