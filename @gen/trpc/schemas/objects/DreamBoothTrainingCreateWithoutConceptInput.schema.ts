...
const Schema: z.ZodType<Prisma.DreamBoothTrainingCreateWithoutConceptInput> = z
  .object({
...
export const DreamBoothTrainingCreateWithoutConceptInputObjectSchema = Schema
