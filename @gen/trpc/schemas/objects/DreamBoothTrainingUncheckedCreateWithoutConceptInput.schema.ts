...
const Schema: z.ZodType<Prisma.DreamBoothTrainingUncheckedCreateWithoutConceptInput> =
  z
    .object({
...
export const DreamBoothTrainingUncheckedCreateWithoutConceptInputObjectSchema =
  Schema
