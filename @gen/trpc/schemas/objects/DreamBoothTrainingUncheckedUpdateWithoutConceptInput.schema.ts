...
const Schema: z.ZodType<Prisma.DreamBoothTrainingUncheckedUpdateWithoutConceptInput> =
  z
    .object({
      id: z
        .union([
...
export const DreamBoothTrainingUncheckedUpdateWithoutConceptInputObjectSchema =
  Schema
