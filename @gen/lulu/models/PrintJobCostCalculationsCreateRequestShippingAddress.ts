 ...
 * @export
 * @interface PrintJobCostCalculationsCreateRequestShippingAddress
 */
export interface PrintJobCostCalculationsCreateRequestShippingAddress {
    /**
     * 
     * @type {string}
     * @memberof PrintJobCostCalculationsCreateRequestShippingAddress
     */
    city: string;
    /**
    ...
    organization?: string;
    /**
     * Validation Regex Pattern: `^\+?[\d\s\-.\/()]{8,20}$`
     * @type {string}
     * @memberof PrintJobCostCalculationsCreateRequestShippingAddress
     */
    phone_number: string;
     ...
     * @memberof PrintJobCostCalculationsCreateRequestShippingAddress
     */
    title?: PrintJobCostCalculationsCreateRequestShippingAddressTitleEnum;
}
 ...
 * @export
 */
export const PrintJobCostCalculationsCreateRequestShippingAddressTitleEnum = {
    Mr: 'MR',
    Miss: 'MISS',
    Mrs: 'MRS',
    Ms: 'MS',
...
export type PrintJobCostCalculationsCreateRequestShippingAddressTitleEnum = typeof PrintJobCostCalculationsCreateRequestShippingAddressTitleEnum[keyof typeof PrintJobCostCalculationsCreateRequestShippingAddressTitleEnum];


/**
 * Check if a given object implements the PrintJobCostCalculationsCreateRequestShippingAddress interface.
 */
export function instanceOfPrintJobCostCalculationsCreateRequestShippingAddress(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostCalculationsCreateRequestShippingAddressFromJSON(json: any): PrintJobCostCalculationsCreateRequestShippingAddress {
    return PrintJobCostCalculationsCreateRequestShippingAddressFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreateRequestShippingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreateRequestShippingAddress {
    ...
    return {
        ...
        'is_business': !exists(json, 'is_business') ? undefined : json['is_business'],
...
export function PrintJobCostCalculationsCreateRequestShippingAddressToJSON(value?: PrintJobCostCalculationsCreateRequestShippingAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
