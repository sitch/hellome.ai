...
/**
 * Summary of the shipping costs
 * @export
 * @interface PrintJobCostCalculationsCreate201ResponseShippingCost
 */
export interface PrintJobCostCalculationsCreate201ResponseShippingCost {
    /**
     * Tax rate that was applied on shipping costs as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseShippingCost
     */
    readonly tax_rate?: string;
    /**
     * Total shipping costs excluding taxes as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseShippingCost
     */
    readonly total_cost_excl_tax?: string;
    /**
     * Total shipping costs including taxes as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseShippingCost
     */
    readonly total_cost_incl_tax?: string;
    /**
     * Total amount of taxes on shipping as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseShippingCost
     */
...
/**
 * Check if a given object implements the PrintJobCostCalculationsCreate201ResponseShippingCost interface.
 */
export function instanceOfPrintJobCostCalculationsCreate201ResponseShippingCost(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobCostCalculationsCreate201ResponseShippingCostFromJSON(json: any): PrintJobCostCalculationsCreate201ResponseShippingCost {
    return PrintJobCostCalculationsCreate201ResponseShippingCostFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreate201ResponseShippingCostFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreate201ResponseShippingCost {
...
export function PrintJobCostCalculationsCreate201ResponseShippingCostToJSON(value?: PrintJobCostCalculationsCreate201ResponseShippingCost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
