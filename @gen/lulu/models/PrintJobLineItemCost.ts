 ...
 * @export
 * @interface PrintJobLineItemCost
 */
export interface PrintJobLineItemCost {
    /**
     * Per unit cost without any discounts applied as a decimal string
     * @type {string}
     * @memberof PrintJobLineItemCost
     */
...
/**
 * Check if a given object implements the PrintJobLineItemCost interface.
 */
export function instanceOfPrintJobLineItemCost(value: object): boolean {
    let isInstance = true;
...
export function PrintJobLineItemCostFromJSON(json: any): PrintJobLineItemCost {
    return PrintJobLineItemCostFromJSONTyped(json, false);
}

export function PrintJobLineItemCostFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobLineItemCost {
...
export function PrintJobLineItemCostToJSON(value?: PrintJobLineItemCost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
