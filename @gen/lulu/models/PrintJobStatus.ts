 ...
 * @export
 */
export const PrintJobStatusNameEnum = {
    Created: 'CREATED',
    Rejected: 'REJECTED',
    Unpaid: 'UNPAID',
...
export type PrintJobStatusNameEnum = typeof PrintJobStatusNameEnum[keyof typeof PrintJobStatusNameEnum];


/**
 * Check if a given object implements the PrintJobStatus interface.
 */
export function instanceOfPrintJobStatus(value: object): boolean {
    let isInstance = true;
...
export function PrintJobStatusFromJSON(json: any): PrintJobStatus {
    return PrintJobStatusFromJSONTyped(json, false);
}

export function PrintJobStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobStatus {
...
export function PrintJobStatusToJSON(value?: PrintJobStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
