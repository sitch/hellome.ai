 ...
 * @export
 * @interface PrintJobsCreateRequest
 */
export interface PrintJobsCreateRequest {
    /**
     ...
     * @type {string}
     * @memberof PrintJobsCreateRequest
     */
     ...
     * @memberof PrintJobsCreateRequest
     */
    shipping_level: PrintJobsCreateRequestShippingLevelEnum;
    /**
 ...
 * @export
 */
export const PrintJobsCreateRequestShippingLevelEnum = {
    Mail: 'MAIL',
...
export type PrintJobsCreateRequestShippingLevelEnum = typeof PrintJobsCreateRequestShippingLevelEnum[keyof typeof PrintJobsCreateRequestShippingLevelEnum];


/**
 * Check if a given object implements the PrintJobsCreateRequest interface.
 */
export function instanceOfPrintJobsCreateRequest(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsCreateRequestFromJSON(json: any): PrintJobsCreateRequest {
    return PrintJobsCreateRequestFromJSONTyped(json, false);
}

export function PrintJobsCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsCreateRequest {
...
export function PrintJobsCreateRequestToJSON(value?: PrintJobsCreateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
