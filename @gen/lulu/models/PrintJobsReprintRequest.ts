...
import type { PrintJobsReprintRequestLineItemsInner } from './PrintJobsReprintRequestLineItemsInner';
import {
    PrintJobsReprintRequestLineItemsInnerFromJSON,
    PrintJobsReprintRequestLineItemsInnerFromJSONTyped,
    PrintJobsReprintRequestLineItemsInnerToJSON,
} from './PrintJobsReprintRequestLineItemsInner';

/**
 * The job resource that represents a print order
 * @export
 * @interface PrintJobsReprintRequest
 */
export interface PrintJobsReprintRequest {
    /**
     ...
     * @type {string}
     * @memberof PrintJobsReprintRequest
     */
     ...
     * @type {Array<PrintJobsReprintRequestLineItemsInner>}
     * @memberof PrintJobsReprintRequest
     */
    line_items: Array<PrintJobsReprintRequestLineItemsInner>;
    /**
     ...
     * @memberof PrintJobsReprintRequest
     */
    shipping_level: PrintJobsReprintRequestShippingLevelEnum;
    /**
 ...
 * @export
 */
export const PrintJobsReprintRequestShippingLevelEnum = {
    Mail: 'MAIL',
...
export type PrintJobsReprintRequestShippingLevelEnum = typeof PrintJobsReprintRequestShippingLevelEnum[keyof typeof PrintJobsReprintRequestShippingLevelEnum];


/**
 * Check if a given object implements the PrintJobsReprintRequest interface.
 */
export function instanceOfPrintJobsReprintRequest(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsReprintRequestFromJSON(json: any): PrintJobsReprintRequest {
    return PrintJobsReprintRequestFromJSONTyped(json, false);
}

export function PrintJobsReprintRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsReprintRequest {
    ...
    return {
        ...
        'line_items': ((json['line_items'] as Array<any>).map(PrintJobsReprintRequestLineItemsInnerFromJSON)),
...
export function PrintJobsReprintRequestToJSON(value?: PrintJobsReprintRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'line_items': ((value.line_items as Array<any>).map(PrintJobsReprintRequestLineItemsInnerToJSON)),
