...
import type { PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization } from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization';
import type { PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrl } from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrl';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrlFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrlFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrlToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrl';

/**
 * A map of status related messages / data
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages {
    /**
     * Expected delay in hours for error status'
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
     */
    ...
    /**
     * General info message on the status
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
     */
    ...
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
     */
    printable_normalization?: PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization;
    /**
     * [ISO 8601](https://www.w3.org/TR/NOTE-datetime)) timestamp of last status change
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
     */
    ...
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrl}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages
     */
    url?: PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrl;
}

/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerStatusMessages(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages {
    return PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages {
    ...
    return {
        ...
        'printable_normalization': !exists(json, 'printable_normalization') ? undefined : PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSON(json['printable_normalization']),
        'timestamp': !exists(json, 'timestamp') ? undefined : json['timestamp'],
        'url': !exists(json, 'url') ? undefined : PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrlFromJSON(json['url']),
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'printable_normalization': PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationToJSON(value.printable_normalization),
        'url': PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesUrlToJSON(value.url),
    };
}
