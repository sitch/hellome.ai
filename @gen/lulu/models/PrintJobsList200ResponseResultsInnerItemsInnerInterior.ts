...
import {
    PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf,
    instanceOfPrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf,
    PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf';
import {
    string,
    instanceOfstring,
    stringFromJSON,
 ...
 * Shorthand of the interior source definition. If used together with 'cover' , it can replace 'printable_normalization'. Alternatively to both options, a 'printable_id' of an existing printable can be provided.
 * @export
 */
export type PrintJobsList200ResponseResultsInnerItemsInnerInterior = PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf | string;

export function PrintJobsList200ResponseResultsInnerItemsInnerInteriorFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerInterior {
    return PrintJobsList200ResponseResultsInnerItemsInnerInteriorFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerInteriorFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerInterior {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSONTyped(json, true), ...stringFromJSONTyped(json, true) };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerInteriorToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerInterior | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfPrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf(value)) {
        return PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfToJSON(value as PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf);
    }
