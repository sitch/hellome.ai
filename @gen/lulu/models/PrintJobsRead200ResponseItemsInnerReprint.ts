...
/**
 * This object contains additional informations in case the job is a reprint of another Print-Job. Require the role 'print.print-job-reprint'
 * @export
 * @interface PrintJobsRead200ResponseItemsInnerReprint
 */
export interface PrintJobsRead200ResponseItemsInnerReprint {
    /**
     * The categorical reason for the reprint, according to our internal list.
     * @type {string}
     * @memberof PrintJobsRead200ResponseItemsInnerReprint
     */
    readonly defect: string;
}

/**
 * Check if a given object implements the PrintJobsRead200ResponseItemsInnerReprint interface.
 */
export function instanceOfPrintJobsRead200ResponseItemsInnerReprint(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "defect" in value;

    return isInstance;
}

export function PrintJobsRead200ResponseItemsInnerReprintFromJSON(json: any): PrintJobsRead200ResponseItemsInnerReprint {
    return PrintJobsRead200ResponseItemsInnerReprintFromJSONTyped(json, false);
}

export function PrintJobsRead200ResponseItemsInnerReprintFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsRead200ResponseItemsInnerReprint {
...
export function PrintJobsRead200ResponseItemsInnerReprintToJSON(value?: PrintJobsRead200ResponseItemsInnerReprint | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
