...
import type { PrintJobsCosts200ResponseLineItemCostsInner } from './PrintJobsCosts200ResponseLineItemCostsInner';
import {
    PrintJobsCosts200ResponseLineItemCostsInnerFromJSON,
    PrintJobsCosts200ResponseLineItemCostsInnerFromJSONTyped,
    PrintJobsCosts200ResponseLineItemCostsInnerToJSON,
} from './PrintJobsCosts200ResponseLineItemCostsInner';

/**
 * Summary of the costs of a Print-Job
 * @export
 * @interface PrintJobCostWithLineItemIds
 */
export interface PrintJobCostWithLineItemIds {
    /**
     * List of cost summaries for each line item
     * @type {Array<PrintJobsCosts200ResponseLineItemCostsInner>}
     * @memberof PrintJobCostWithLineItemIds
     */
    readonly line_item_costs: Array<PrintJobsCosts200ResponseLineItemCostsInner>;
}

/**
 * Check if a given object implements the PrintJobCostWithLineItemIds interface.
 */
export function instanceOfPrintJobCostWithLineItemIds(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostWithLineItemIdsFromJSON(json: any): PrintJobCostWithLineItemIds {
    return PrintJobCostWithLineItemIdsFromJSONTyped(json, false);
}

export function PrintJobCostWithLineItemIdsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostWithLineItemIds {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'line_item_costs': ((json['line_item_costs'] as Array<any>).map(PrintJobsCosts200ResponseLineItemCostsInnerFromJSON)),
    };
}

export function PrintJobCostWithLineItemIdsToJSON(value?: PrintJobCostWithLineItemIds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
