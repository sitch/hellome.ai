...
import type { PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages } from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages';

/**
 * Status object that contains the actual line item processing status as well as additional status related data
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerStatus
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerStatus {
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatus
     */
    messages?: PrintJobsList200ResponseResultsInnerItemsInnerStatusMessages;
    /**
     * The actual processing status of the Print-Job.
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatus
     */
    name: PrintJobsList200ResponseResultsInnerItemsInnerStatusNameEnum;
}
 ...
 * @export
 */
export const PrintJobsList200ResponseResultsInnerItemsInnerStatusNameEnum = {
    Created: 'CREATED',
    Accepted: 'ACCEPTED',
    Rejected: 'REJECTED',
...
export type PrintJobsList200ResponseResultsInnerItemsInnerStatusNameEnum = typeof PrintJobsList200ResponseResultsInnerItemsInnerStatusNameEnum[keyof typeof PrintJobsList200ResponseResultsInnerItemsInnerStatusNameEnum];


/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerStatus interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerStatus(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerItemsInnerStatusFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerStatus {
    return PrintJobsList200ResponseResultsInnerItemsInnerStatusFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerStatus {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'messages': !exists(json, 'messages') ? undefined : PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesFromJSON(json['messages']),
        'name': json['name'],
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'messages': PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesToJSON(value.messages),
        'name': value.name,
    };
}
