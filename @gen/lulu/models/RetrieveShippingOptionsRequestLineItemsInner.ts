 ...
 * 
 * @export
 * @interface RetrieveShippingOptionsRequestLineItemsInner
 */
export interface RetrieveShippingOptionsRequestLineItemsInner {
    /**
     * The page count of the book
     * @type {number}
     * @memberof RetrieveShippingOptionsRequestLineItemsInner
     */
    page_count: number;
    /**
    ...
    /**
     * The quantity of books to base the calculations on
     * @type {number}
     * @memberof RetrieveShippingOptionsRequestLineItemsInner
     */
    quantity: number;
...
/**
 * Check if a given object implements the RetrieveShippingOptionsRequestLineItemsInner interface.
 */
export function instanceOfRetrieveShippingOptionsRequestLineItemsInner(value: object): boolean {
    let isInstance = true;
...
export function RetrieveShippingOptionsRequestLineItemsInnerFromJSON(json: any): RetrieveShippingOptionsRequestLineItemsInner {
    return RetrieveShippingOptionsRequestLineItemsInnerFromJSONTyped(json, false);
}

export function RetrieveShippingOptionsRequestLineItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveShippingOptionsRequestLineItemsInner {
...
export function RetrieveShippingOptionsRequestLineItemsInnerToJSON(value?: RetrieveShippingOptionsRequestLineItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
