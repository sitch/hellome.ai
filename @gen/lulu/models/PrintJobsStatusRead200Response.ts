...
/**
 * Status object that contains the actual PrintJob processing status as well as some additional status related data
 * @export
 * @interface PrintJobsStatusRead200Response
 */
export interface PrintJobsStatusRead200Response {
    /**
     * [ISO 8601](https://www.w3.org/TR/NOTE-datetime)) Timestamp of the latest status change
     * @type {Date}
     * @memberof PrintJobsStatusRead200Response
     */
     ...
     * @memberof PrintJobsStatusRead200Response
     */
    name: PrintJobsStatusRead200ResponseNameEnum;
}
 ...
 * @export
 */
export const PrintJobsStatusRead200ResponseNameEnum = {
    Created: 'CREATED',
    Rejected: 'REJECTED',
    Unpaid: 'UNPAID',
    PaymentInProgress: 'PAYMENT_IN_PROGRESS',
    ProductionReady: 'PRODUCTION_READY',
    ProductionDelayed: 'PRODUCTION_DELAYED',
    InProduction: 'IN_PRODUCTION',
    Error: 'ERROR',
    Shipped: 'SHIPPED',
    Canceled: 'CANCELED'
} as const;
export type PrintJobsStatusRead200ResponseNameEnum = typeof PrintJobsStatusRead200ResponseNameEnum[keyof typeof PrintJobsStatusRead200ResponseNameEnum];


/**
 * Check if a given object implements the PrintJobsStatusRead200Response interface.
 */
export function instanceOfPrintJobsStatusRead200Response(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsStatusRead200ResponseFromJSON(json: any): PrintJobsStatusRead200Response {
    return PrintJobsStatusRead200ResponseFromJSONTyped(json, false);
}

export function PrintJobsStatusRead200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsStatusRead200Response {
...
export function PrintJobsStatusRead200ResponseToJSON(value?: PrintJobsStatusRead200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
