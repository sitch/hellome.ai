 ...
 * @export
 * @interface PrintJobsCosts200Response
 */
export interface PrintJobsCosts200Response {
    /**
     * List of cost summaries for each line item
     * @type {Array<PrintJobsCosts200ResponseLineItemCostsInner>}
     * @memberof PrintJobsCosts200Response
     */
    readonly line_item_costs: Array<PrintJobsCosts200ResponseLineItemCostsInner>;
}

/**
 * Check if a given object implements the PrintJobsCosts200Response interface.
 */
export function instanceOfPrintJobsCosts200Response(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsCosts200ResponseFromJSON(json: any): PrintJobsCosts200Response {
    return PrintJobsCosts200ResponseFromJSONTyped(json, false);
}

export function PrintJobsCosts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsCosts200Response {
...
export function PrintJobsCosts200ResponseToJSON(value?: PrintJobsCosts200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
