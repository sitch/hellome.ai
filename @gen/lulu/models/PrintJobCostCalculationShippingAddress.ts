 ...
 * @export
 * @interface PrintJobCostCalculationShippingAddress
 */
export interface PrintJobCostCalculationShippingAddress {
    /**
     * 
     * @type {string}
     * @memberof PrintJobCostCalculationShippingAddress
     */
    city: string;
    /**
     ...
     * @memberof PrintJobCostCalculationShippingAddress
     */
    title?: PrintJobCostCalculationShippingAddressTitleEnum;
}
 ...
 * @export
 */
export const PrintJobCostCalculationShippingAddressTitleEnum = {
    Mr: 'MR',
    Miss: 'MISS',
    Mrs: 'MRS',
    Ms: 'MS',
...
export type PrintJobCostCalculationShippingAddressTitleEnum = typeof PrintJobCostCalculationShippingAddressTitleEnum[keyof typeof PrintJobCostCalculationShippingAddressTitleEnum];


/**
 * Check if a given object implements the PrintJobCostCalculationShippingAddress interface.
 */
export function instanceOfPrintJobCostCalculationShippingAddress(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostCalculationShippingAddressFromJSON(json: any): PrintJobCostCalculationShippingAddress {
    return PrintJobCostCalculationShippingAddressFromJSONTyped(json, false);
}

export function PrintJobCostCalculationShippingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationShippingAddress {
...
export function PrintJobCostCalculationShippingAddressToJSON(value?: PrintJobCostCalculationShippingAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
