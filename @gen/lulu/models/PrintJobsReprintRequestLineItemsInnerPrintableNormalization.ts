...
/**
 * Can be omitted if a valid 'printable_id' of an existing printable is provided.
 * @export
 * @interface PrintJobsReprintRequestLineItemsInnerPrintableNormalization
 */
export interface PrintJobsReprintRequestLineItemsInnerPrintableNormalization {
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover}
     * @memberof PrintJobsReprintRequestLineItemsInnerPrintableNormalization
     */
...
/**
 * Check if a given object implements the PrintJobsReprintRequestLineItemsInnerPrintableNormalization interface.
 */
export function instanceOfPrintJobsReprintRequestLineItemsInnerPrintableNormalization(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSON(json: any): PrintJobsReprintRequestLineItemsInnerPrintableNormalization {
    return PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSONTyped(json, false);
}

export function PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsReprintRequestLineItemsInnerPrintableNormalization {
...
export function PrintJobsReprintRequestLineItemsInnerPrintableNormalizationToJSON(value?: PrintJobsReprintRequestLineItemsInnerPrintableNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
