...
export interface UnavailableError {
     ...
     * 
     * @type {string}
     * @memberof UnavailableError
     */
    detail: string;
}

/**
 * Check if a given object implements the UnavailableError interface.
 */
export function instanceOfUnavailableError(value: object): boolean {
    let isInstance = true;
...
export function UnavailableErrorFromJSON(json: any): UnavailableError {
    return UnavailableErrorFromJSONTyped(json, false);
}

export function UnavailableErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnavailableError {
...
export function UnavailableErrorToJSON(value?: UnavailableError | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
