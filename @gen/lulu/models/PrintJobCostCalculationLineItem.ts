 ...
 * @export
 * @interface PrintJobCostCalculationLineItem
 */
export interface PrintJobCostCalculationLineItem {
    /**
     * The page count of the book
     * @type {number}
     * @memberof PrintJobCostCalculationLineItem
     */
    page_count: number;
    /**
...
/**
 * Check if a given object implements the PrintJobCostCalculationLineItem interface.
 */
export function instanceOfPrintJobCostCalculationLineItem(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostCalculationLineItemFromJSON(json: any): PrintJobCostCalculationLineItem {
    return PrintJobCostCalculationLineItemFromJSONTyped(json, false);
}

export function PrintJobCostCalculationLineItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationLineItem {
...
export function PrintJobCostCalculationLineItemToJSON(value?: PrintJobCostCalculationLineItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
