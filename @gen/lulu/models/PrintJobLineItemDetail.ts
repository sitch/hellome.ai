 ...
 * @export
 * @interface PrintJobLineItemDetail
 */
export interface PrintJobLineItemDetail {
    /**
     * 
     * @type {PrintJobsRead200ResponseItemsInnerReprint}
     * @memberof PrintJobLineItemDetail
     */
    reprint?: PrintJobsRead200ResponseItemsInnerReprint;
}

/**
 * Check if a given object implements the PrintJobLineItemDetail interface.
 */
export function instanceOfPrintJobLineItemDetail(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobLineItemDetailFromJSON(json: any): PrintJobLineItemDetail {
    return PrintJobLineItemDetailFromJSONTyped(json, false);
}

export function PrintJobLineItemDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobLineItemDetail {
...
export function PrintJobLineItemDetailToJSON(value?: PrintJobLineItemDetail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
