...
/**
 * Check if a given object implements the PrintJobDetail interface.
 */
export function instanceOfPrintJobDetail(value: object): boolean {
    let isInstance = true;
...
export function PrintJobDetailFromJSON(json: any): PrintJobDetail {
    return PrintJobDetailFromJSONTyped(json, false);
}

export function PrintJobDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobDetail {
...
export function PrintJobDetailToJSON(value?: PrintJobDetail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
