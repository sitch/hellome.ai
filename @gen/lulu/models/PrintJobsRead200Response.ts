...
import type { PrintJobsRead200ResponseItemsInner } from './PrintJobsRead200ResponseItemsInner';
import {
    PrintJobsRead200ResponseItemsInnerFromJSON,
    PrintJobsRead200ResponseItemsInnerFromJSONTyped,
    PrintJobsRead200ResponseItemsInnerToJSON,
} from './PrintJobsRead200ResponseItemsInner';

/**
 * The extended version of a Print-Job resource that is returned by the detail endpoint
 * @export
 * @interface PrintJobsRead200Response
 */
export interface PrintJobsRead200Response {
    /**
     * The ids of reprints of this Print-Job. Requires role 'print.print-job-reprint'
     * @type {Array<number>}
     * @memberof PrintJobsRead200Response
     */
    readonly child_job_ids?: Array<number>;
    /**
     * The line items of a Print-Job, defining it's Printables and their quantities. The property name 'line_items' can be used instead.
     * @type {Array<PrintJobsRead200ResponseItemsInner>}
     * @memberof PrintJobsRead200Response
     */
    items?: Array<PrintJobsRead200ResponseItemsInner>;
    /**
     * The line items of a Print-Job, defining it's Printables and their quantities. The property name 'items' can be used instead.
     * @type {Array<PrintJobsRead200ResponseItemsInner>}
     * @memberof PrintJobsRead200Response
     */
    line_items: Array<PrintJobsRead200ResponseItemsInner>;
    /**
     * If this Print-Job is a reprint, this is the id of the original job. Requires role 'print.print-job-reprint'
     * @type {number}
     * @memberof PrintJobsRead200Response
     */
    readonly parent_job_id?: number;
}

/**
 * Check if a given object implements the PrintJobsRead200Response interface.
 */
export function instanceOfPrintJobsRead200Response(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsRead200ResponseFromJSON(json: any): PrintJobsRead200Response {
    return PrintJobsRead200ResponseFromJSONTyped(json, false);
}

export function PrintJobsRead200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsRead200Response {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'child_job_ids': !exists(json, 'child_job_ids') ? undefined : json['child_job_ids'],
        'items': !exists(json, 'items') ? undefined : ((json['items'] as Array<any>).map(PrintJobsRead200ResponseItemsInnerFromJSON)),
        'line_items': ((json['line_items'] as Array<any>).map(PrintJobsRead200ResponseItemsInnerFromJSON)),
        'parent_job_id': !exists(json, 'parent_job_id') ? undefined : json['parent_job_id'],
    };
}

export function PrintJobsRead200ResponseToJSON(value?: PrintJobsRead200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'items': value.items === undefined ? undefined : ((value.items as Array<any>).map(PrintJobsRead200ResponseItemsInnerToJSON)),
        'line_items': ((value.line_items as Array<any>).map(PrintJobsRead200ResponseItemsInnerToJSON)),
    };
}
