 ...
 * @export
 * @interface ShippingOptionsList200ResponseResultsInner
 */
export interface ShippingOptionsList200ResponseResultsInner {
    /**
     * Delivery only on working days
     * @type {boolean}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly business_only: boolean;
    /**
     ...
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly level: ShippingOptionsList200ResponseResultsInnerLevelEnum;
    /**
     * Latest estimated delivery date in ([ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format. When no `pod_package_id` is provided in the request, the estimate is based on product types with the longest estimated production time (usually hardcover books).
     * @type {string}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly max_delivery_date: string;
    /**
     * Latest estimated dispatch (handover to carrier) date in ([ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format. When no `pod_package_id` is provided in the request, the estimate is based on product types with the longest estimated production time (usually hardcover books).
     * @type {string}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly max_dispatch_date?: string;
    /**
     * Earliest estimated delivery date in ([ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format. When no `pod_package_id` is provided in the request, the estimate is based on product types with the shortest estimated production time (usually non-hardcover books).
     * @type {string}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly min_delivery_date: string;
    /**
     * Earliest estimated dispatch (handover to carrier) date in ([ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format. When no `pod_package_id` is provided in the request, the estimate is based on product types with the shortest estimated production time (usually non-hardcover books).
     * @type {string}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly min_dispatch_date?: string;
    /**
     * Support of delivery to postboxes
     * @type {boolean}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly postbox_ok: boolean;
    /**
     * Production related delay
     * @type {number}
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly shipping_buffer: number;
    /**
     ...
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly total_days_max?: number;
    /**
     ...
     * @memberof ShippingOptionsList200ResponseResultsInner
     */
    readonly total_days_min?: number;
    /**
 ...
 * @export
 */
export const ShippingOptionsList200ResponseResultsInnerLevelEnum = {
    Mail: 'MAIL',
...
export type ShippingOptionsList200ResponseResultsInnerLevelEnum = typeof ShippingOptionsList200ResponseResultsInnerLevelEnum[keyof typeof ShippingOptionsList200ResponseResultsInnerLevelEnum];


/**
 * Check if a given object implements the ShippingOptionsList200ResponseResultsInner interface.
 */
export function instanceOfShippingOptionsList200ResponseResultsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "business_only" in value;
    isInstance = isInstance && "home_only" in value;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "level" in value;
    isInstance = isInstance && "max_delivery_date" in value;
    isInstance = isInstance && "min_delivery_date" in value;
    isInstance = isInstance && "postbox_ok" in value;
    isInstance = isInstance && "shipping_buffer" in value;
    isInstance = isInstance && "traceable" in value;
    isInstance = isInstance && "transit_time" in value;

    return isInstance;
}

export function ShippingOptionsList200ResponseResultsInnerFromJSON(json: any): ShippingOptionsList200ResponseResultsInner {
    return ShippingOptionsList200ResponseResultsInnerFromJSONTyped(json, false);
}

export function ShippingOptionsList200ResponseResultsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingOptionsList200ResponseResultsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'business_only': json['business_only'],
        'cost_excl_tax': !exists(json, 'cost_excl_tax') ? undefined : json['cost_excl_tax'],
        'currency': !exists(json, 'currency') ? undefined : json['currency'],
        'home_only': json['home_only'],
        'id': json['id'],
        'level': json['level'],
        'max_delivery_date': json['max_delivery_date'],
        'max_dispatch_date': !exists(json, 'max_dispatch_date') ? undefined : json['max_dispatch_date'],
        'min_delivery_date': json['min_delivery_date'],
        'min_dispatch_date': !exists(json, 'min_dispatch_date') ? undefined : json['min_dispatch_date'],
        'postbox_ok': json['postbox_ok'],
        'shipping_buffer': json['shipping_buffer'],
        'total_days_max': !exists(json, 'total_days_max') ? undefined : json['total_days_max'],
        'total_days_min': !exists(json, 'total_days_min') ? undefined : json['total_days_min'],
        'traceable': json['traceable'],
        'transit_time': json['transit_time'],
    };
}

export function ShippingOptionsList200ResponseResultsInnerToJSON(value?: ShippingOptionsList200ResponseResultsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
