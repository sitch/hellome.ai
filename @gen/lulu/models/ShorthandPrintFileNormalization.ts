...
/**
 * @type ShorthandPrintFileNormalization
 * 
 * @export
 */
export type ShorthandPrintFileNormalization = PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf | string;

export function ShorthandPrintFileNormalizationFromJSON(json: any): ShorthandPrintFileNormalization {
    return ShorthandPrintFileNormalizationFromJSONTyped(json, false);
}

export function ShorthandPrintFileNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShorthandPrintFileNormalization {
...
export function ShorthandPrintFileNormalizationToJSON(value?: ShorthandPrintFileNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
