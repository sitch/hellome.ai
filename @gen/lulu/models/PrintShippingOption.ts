 ...
 * @export
 * @interface PrintShippingOption
 */
export interface PrintShippingOption {
    /**
     * Delivery only on working days
     * @type {boolean}
     * @memberof PrintShippingOption
     */
     ...
     * @memberof PrintShippingOption
     */
    readonly level: PrintShippingOptionLevelEnum;
    /**
 ...
 * @export
 */
export const PrintShippingOptionLevelEnum = {
    Mail: 'MAIL',
...
export type PrintShippingOptionLevelEnum = typeof PrintShippingOptionLevelEnum[keyof typeof PrintShippingOptionLevelEnum];


/**
 * Check if a given object implements the PrintShippingOption interface.
 */
export function instanceOfPrintShippingOption(value: object): boolean {
    let isInstance = true;
...
export function PrintShippingOptionFromJSON(json: any): PrintShippingOption {
    return PrintShippingOptionFromJSONTyped(json, false);
}

export function PrintShippingOptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintShippingOption {
...
export function PrintShippingOptionToJSON(value?: PrintShippingOption | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
