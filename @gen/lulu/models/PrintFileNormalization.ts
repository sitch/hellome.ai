 ...
 * 
 * @export
 * @interface PrintFileNormalization
 */
export interface PrintFileNormalization {
    /**
     * The id of the normalization job (either a InteriorNormalizationJob or a CoverNormalizationJob)
     * @type {number}
     * @memberof PrintFileNormalization
     */
    job_id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the PrintFileNormalization interface.
 */
export function instanceOfPrintFileNormalization(value: object): boolean {
    let isInstance = true;
...
export function PrintFileNormalizationFromJSON(json: any): PrintFileNormalization {
    return PrintFileNormalizationFromJSONTyped(json, false);
}

export function PrintFileNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintFileNormalization {
...
export function PrintFileNormalizationToJSON(value?: PrintFileNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
