...
import type { PrintJobsRead200ResponseItemsInnerReprint } from './PrintJobsRead200ResponseItemsInnerReprint';
import {
    PrintJobsRead200ResponseItemsInnerReprintFromJSON,
    PrintJobsRead200ResponseItemsInnerReprintFromJSONTyped,
    PrintJobsRead200ResponseItemsInnerReprintToJSON,
} from './PrintJobsRead200ResponseItemsInnerReprint';

/**
 * The extended version of a Print-JobLineItem resource that is returned by the detail endpoint
 * @export
 * @interface PrintJobsRead200ResponseItemsInner
 */
export interface PrintJobsRead200ResponseItemsInner {
    /**
     * 
     * @type {PrintJobsRead200ResponseItemsInnerReprint}
     * @memberof PrintJobsRead200ResponseItemsInner
     */
    reprint?: PrintJobsRead200ResponseItemsInnerReprint;
}

/**
 * Check if a given object implements the PrintJobsRead200ResponseItemsInner interface.
 */
export function instanceOfPrintJobsRead200ResponseItemsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsRead200ResponseItemsInnerFromJSON(json: any): PrintJobsRead200ResponseItemsInner {
    return PrintJobsRead200ResponseItemsInnerFromJSONTyped(json, false);
}

export function PrintJobsRead200ResponseItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsRead200ResponseItemsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'reprint': !exists(json, 'reprint') ? undefined : PrintJobsRead200ResponseItemsInnerReprintFromJSON(json['reprint']),
    };
}

export function PrintJobsRead200ResponseItemsInnerToJSON(value?: PrintJobsRead200ResponseItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'reprint': PrintJobsRead200ResponseItemsInnerReprintToJSON(value.reprint),
    };
}
