...
/**
 * The estimated ship and delivery dates for a Print-Job
 * @export
 * @interface PrintJobsList200ResponseResultsInnerEstimatedShippingDates
 */
export interface PrintJobsList200ResponseResultsInnerEstimatedShippingDates {
    /**
     * The slowest estimated delivery date for a Print-Job in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerEstimatedShippingDates
     */
    readonly arrival_max?: string;
    /**
     * The fastest estimated delivery date for a Print-Job in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerEstimatedShippingDates
     */
    readonly arrival_min?: string;
    /**
     * The slowest estimated ship date for a Print-Job in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerEstimatedShippingDates
     */
    readonly dispatch_max?: string;
    /**
     * The fastest estimated ship date for a Print-Job in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)) format
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerEstimatedShippingDates
     */
    readonly dispatch_min?: string;
}

/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerEstimatedShippingDates interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerEstimatedShippingDates(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerEstimatedShippingDatesFromJSON(json: any): PrintJobsList200ResponseResultsInnerEstimatedShippingDates {
    return PrintJobsList200ResponseResultsInnerEstimatedShippingDatesFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerEstimatedShippingDatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerEstimatedShippingDates {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'arrival_max': !exists(json, 'arrival_max') ? undefined : json['arrival_max'],
        'arrival_min': !exists(json, 'arrival_min') ? undefined : json['arrival_min'],
        'dispatch_max': !exists(json, 'dispatch_max') ? undefined : json['dispatch_max'],
        'dispatch_min': !exists(json, 'dispatch_min') ? undefined : json['dispatch_min'],
    };
}

export function PrintJobsList200ResponseResultsInnerEstimatedShippingDatesToJSON(value?: PrintJobsList200ResponseResultsInnerEstimatedShippingDates | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
