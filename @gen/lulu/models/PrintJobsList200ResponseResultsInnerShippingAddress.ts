 ...
 * @export
 * @interface PrintJobsList200ResponseResultsInnerShippingAddress
 */
export interface PrintJobsList200ResponseResultsInnerShippingAddress {
    /**
     * 
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerShippingAddress
     */
    city: string;
    /**
     ...
     * @memberof PrintJobsList200ResponseResultsInnerShippingAddress
     */
    title?: PrintJobsList200ResponseResultsInnerShippingAddressTitleEnum;
}
 ...
 * @export
 */
export const PrintJobsList200ResponseResultsInnerShippingAddressTitleEnum = {
    Mr: 'MR',
    Miss: 'MISS',
    Mrs: 'MRS',
    Ms: 'MS',
...
export type PrintJobsList200ResponseResultsInnerShippingAddressTitleEnum = typeof PrintJobsList200ResponseResultsInnerShippingAddressTitleEnum[keyof typeof PrintJobsList200ResponseResultsInnerShippingAddressTitleEnum];


/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerShippingAddress interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerShippingAddress(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerShippingAddressFromJSON(json: any): PrintJobsList200ResponseResultsInnerShippingAddress {
    return PrintJobsList200ResponseResultsInnerShippingAddressFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerShippingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerShippingAddress {
...
export function PrintJobsList200ResponseResultsInnerShippingAddressToJSON(value?: PrintJobsList200ResponseResultsInnerShippingAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
