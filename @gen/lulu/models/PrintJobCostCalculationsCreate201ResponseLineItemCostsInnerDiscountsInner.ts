 ...
 * 
 * @export
 * @interface PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner
 */
export interface PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner {
    /**
     * The deducted amount as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner
     */
...
/**
 * Check if a given object implements the PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner interface.
 */
export function instanceOfPrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSON(json: any): PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner {
    return PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner {
...
export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerToJSON(value?: PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
