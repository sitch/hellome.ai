 ...
 * @export
 * @interface PrintJobsReprint201Response
 */
export interface PrintJobsReprint201Response {
    /**
     ...
     * @type {string}
     * @memberof PrintJobsReprint201Response
     */
     ...
     * @memberof PrintJobsReprint201Response
     */
    shipping_level: PrintJobsReprint201ResponseShippingLevelEnum;
    /**
 ...
 * @export
 */
export const PrintJobsReprint201ResponseShippingLevelEnum = {
    Mail: 'MAIL',
...
export type PrintJobsReprint201ResponseShippingLevelEnum = typeof PrintJobsReprint201ResponseShippingLevelEnum[keyof typeof PrintJobsReprint201ResponseShippingLevelEnum];


/**
 * Check if a given object implements the PrintJobsReprint201Response interface.
 */
export function instanceOfPrintJobsReprint201Response(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsReprint201ResponseFromJSON(json: any): PrintJobsReprint201Response {
    return PrintJobsReprint201ResponseFromJSONTyped(json, false);
}

export function PrintJobsReprint201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsReprint201Response {
...
export function PrintJobsReprint201ResponseToJSON(value?: PrintJobsReprint201Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
