 ...
 * @export
 * @interface PrintJobsCosts200ResponseLineItemCostsInner
 */
export interface PrintJobsCosts200ResponseLineItemCostsInner {
    /**
     * External id of the line item
     * @type {string}
     * @memberof PrintJobsCosts200ResponseLineItemCostsInner
     */
    readonly line_item_external_id: string;
    /**
     * ID of the line item of this cost summary
     * @type {number}
     * @memberof PrintJobsCosts200ResponseLineItemCostsInner
     */
...
/**
 * Check if a given object implements the PrintJobsCosts200ResponseLineItemCostsInner interface.
 */
export function instanceOfPrintJobsCosts200ResponseLineItemCostsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "line_item_external_id" in value;
    isInstance = isInstance && "line_item_id" in value;

    return isInstance;
}

export function PrintJobsCosts200ResponseLineItemCostsInnerFromJSON(json: any): PrintJobsCosts200ResponseLineItemCostsInner {
    return PrintJobsCosts200ResponseLineItemCostsInnerFromJSONTyped(json, false);
}

export function PrintJobsCosts200ResponseLineItemCostsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsCosts200ResponseLineItemCostsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'line_item_external_id': json['line_item_external_id'],
        'line_item_id': json['line_item_id'],
    };
}

export function PrintJobsCosts200ResponseLineItemCostsInnerToJSON(value?: PrintJobsCosts200ResponseLineItemCostsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
