 ...
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInner
 */
export interface PrintJobsList200ResponseResultsInnerItemsInner {
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerCover}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInner
     */
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInner interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInner(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerItemsInnerFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInner {
    return PrintJobsList200ResponseResultsInnerItemsInnerFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInner {
...
export function PrintJobsList200ResponseResultsInnerItemsInnerToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
