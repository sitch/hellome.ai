 ...
 * @export
 * @interface RetrieveShippingOptionsRequestShippingAddress
 */
export interface RetrieveShippingOptionsRequestShippingAddress {
    /**
     * [ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2) country code
     * @type {string}
     * @memberof RetrieveShippingOptionsRequestShippingAddress
     */
    country: string;
    /**
     * 
    ...
    postcode?: string;
    /**
     * 2 or 3 letter state codes (officially called [ISO-3166-2 subdivision codes](https://en.wikipedia.org/wiki/ISO_3166-2)).
     * @type {string}
     * @memberof RetrieveShippingOptionsRequestShippingAddress
     */
    state?: string;
...
/**
 * Check if a given object implements the RetrieveShippingOptionsRequestShippingAddress interface.
 */
export function instanceOfRetrieveShippingOptionsRequestShippingAddress(value: object): boolean {
    let isInstance = true;
...
export function RetrieveShippingOptionsRequestShippingAddressFromJSON(json: any): RetrieveShippingOptionsRequestShippingAddress {
    return RetrieveShippingOptionsRequestShippingAddressFromJSONTyped(json, false);
}

export function RetrieveShippingOptionsRequestShippingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveShippingOptionsRequestShippingAddress {
    ...
    return {
        ...
        'is_postbox': !exists(json, 'is_postbox') ? undefined : json['is_postbox'],
...
export function RetrieveShippingOptionsRequestShippingAddressToJSON(value?: RetrieveShippingOptionsRequestShippingAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
