...
import type { PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile } from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile';

/**
 * Represents the normalization process of the interior source files
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior {
    /**
     * The id of the normalization job (either a InteriorNormalizationJob or a CoverNormalizationJob)
     * @type {number}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior
     */
    job_id?: number;
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior
     */
    normalized_file?: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile;
    /**
     * A md5 hash of the source file to check it's integrity
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior
     */
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior {
    return PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior {
    ...
    return {
        ...
        'normalized_file': !exists(json, 'normalized_file') ? undefined : PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSON(json['normalized_file']),
        'source_md5_sum': !exists(json, 'source_md5_sum') ? undefined : json['source_md5_sum'],
        'source_url': json['source_url'],
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'job_id': value.job_id,
        'normalized_file': PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileToJSON(value.normalized_file),
        'source_md5_sum': value.source_md5_sum,
