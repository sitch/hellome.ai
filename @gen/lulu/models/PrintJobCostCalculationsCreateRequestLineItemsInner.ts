...
/**
 * A Print-Job Cost Calculation Line Item represents a price calculation for a print job line item
 * @export
 * @interface PrintJobCostCalculationsCreateRequestLineItemsInner
 */
export interface PrintJobCostCalculationsCreateRequestLineItemsInner {
    /**
     * The page count of the book
     * @type {number}
     * @memberof PrintJobCostCalculationsCreateRequestLineItemsInner
     */
    page_count: number;
    /**
     * The id of the PodPackage of the book
     * @type {string}
     * @memberof PrintJobCostCalculationsCreateRequestLineItemsInner
     */
...
/**
 * Check if a given object implements the PrintJobCostCalculationsCreateRequestLineItemsInner interface.
 */
export function instanceOfPrintJobCostCalculationsCreateRequestLineItemsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "page_count" in value;
    isInstance = isInstance && "pod_package_id" in value;
    isInstance = isInstance && "quantity" in value;

    return isInstance;
}

export function PrintJobCostCalculationsCreateRequestLineItemsInnerFromJSON(json: any): PrintJobCostCalculationsCreateRequestLineItemsInner {
    return PrintJobCostCalculationsCreateRequestLineItemsInnerFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreateRequestLineItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreateRequestLineItemsInner {
    ...
    return {
        ...
        'pod_package_id': json['pod_package_id'],
        'quantity': json['quantity'],
    };
}

export function PrintJobCostCalculationsCreateRequestLineItemsInnerToJSON(value?: PrintJobCostCalculationsCreateRequestLineItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
