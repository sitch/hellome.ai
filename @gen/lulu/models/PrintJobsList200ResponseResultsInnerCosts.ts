 ...
 * @export
 * @interface PrintJobsList200ResponseResultsInnerCosts
 */
export interface PrintJobsList200ResponseResultsInnerCosts {
    /**
     * 
     * @type {PrintJobCostCalculationsCreate201ResponseLineItemCostsInner}
     * @memberof PrintJobsList200ResponseResultsInnerCosts
     */
    line_item_costs?: PrintJobCostCalculationsCreate201ResponseLineItemCostsInner;
    /**
     * 
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerCosts interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerCosts(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerCostsFromJSON(json: any): PrintJobsList200ResponseResultsInnerCosts {
    return PrintJobsList200ResponseResultsInnerCostsFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerCostsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerCosts {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'line_item_costs': !exists(json, 'line_item_costs') ? undefined : PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSON(json['line_item_costs']),
        'shipping_cost': !exists(json, 'shipping_cost') ? undefined : PrintJobCostCalculationsCreate201ResponseShippingCostFromJSON(json['shipping_cost']),
        'total_cost_excl_tax': !exists(json, 'total_cost_excl_tax') ? undefined : json['total_cost_excl_tax'],
        'total_cost_incl_tax': !exists(json, 'total_cost_incl_tax') ? undefined : json['total_cost_incl_tax'],
        'total_tax': !exists(json, 'total_tax') ? undefined : json['total_tax'],
    };
}

export function PrintJobsList200ResponseResultsInnerCostsToJSON(value?: PrintJobsList200ResponseResultsInnerCosts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'line_item_costs': PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerToJSON(value.line_item_costs),
