...
import type { PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover } from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover';
import type { PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior } from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior';
import {
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSON,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSONTyped,
    PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorToJSON,
} from './PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior';

/**
 * Represents the normalization processes of the interior and cover source files. Alternatively, 'interior' and 'cover' can be set as a shorthand for creation or a 'printable_id' of an existing printable can be provided.
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization {
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization
     */
    cover: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover;
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization
     */
    interior: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInterior;
}

/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "cover" in value;
    isInstance = isInstance && "interior" in value;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization {
    return PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'cover': PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSON(json['cover']),
        'interior': PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorFromJSON(json['interior']),
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'cover': PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverToJSON(value.cover),
        'interior': PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationInteriorToJSON(value.interior),
    };
}
