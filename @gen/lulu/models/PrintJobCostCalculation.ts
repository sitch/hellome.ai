...
import type { PrintJobCostCalculationShippingAddress } from './PrintJobCostCalculationShippingAddress';
import {
    PrintJobCostCalculationShippingAddressFromJSON,
    PrintJobCostCalculationShippingAddressFromJSONTyped,
    PrintJobCostCalculationShippingAddressToJSON,
} from './PrintJobCostCalculationShippingAddress';
 ...
 * @export
 * @interface PrintJobCostCalculation
 */
export interface PrintJobCostCalculation {
    /**
     * The line items that should be calculated
     * @type {Array<PrintJobCostCalculationsCreateRequestLineItemsInner>}
     * @memberof PrintJobCostCalculation
     */
    line_items: Array<PrintJobCostCalculationsCreateRequestLineItemsInner>;
    /**
     * 
     * @type {PrintJobCostCalculationShippingAddress}
     * @memberof PrintJobCostCalculation
     */
    shipping_address: PrintJobCostCalculationShippingAddress;
    /**
     * The shipping option level
     * @type {string}
     * @memberof PrintJobCostCalculation
     */
    shipping_option: PrintJobCostCalculationShippingOptionEnum;
}
 ...
 * @export
 */
export const PrintJobCostCalculationShippingOptionEnum = {
    Mail: 'MAIL',
...
export type PrintJobCostCalculationShippingOptionEnum = typeof PrintJobCostCalculationShippingOptionEnum[keyof typeof PrintJobCostCalculationShippingOptionEnum];


/**
 * Check if a given object implements the PrintJobCostCalculation interface.
 */
export function instanceOfPrintJobCostCalculation(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostCalculationFromJSON(json: any): PrintJobCostCalculation {
    return PrintJobCostCalculationFromJSONTyped(json, false);
}

export function PrintJobCostCalculationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculation {
    ...
    return {
        ...
        'shipping_address': PrintJobCostCalculationShippingAddressFromJSON(json['shipping_address']),
        'shipping_option': json['shipping_option'],
    };
}

export function PrintJobCostCalculationToJSON(value?: PrintJobCostCalculation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'shipping_address': PrintJobCostCalculationShippingAddressToJSON(value.shipping_address),
