...
export interface PrintJob {
     ...
     * @memberof PrintJob
     */
    shipping_level: PrintJobShippingLevelEnum;
    /**
 ...
 * @export
 */
export const PrintJobShippingLevelEnum = {
    Mail: 'MAIL',
...
export type PrintJobShippingLevelEnum = typeof PrintJobShippingLevelEnum[keyof typeof PrintJobShippingLevelEnum];


/**
 * Check if a given object implements the PrintJob interface.
 */
export function instanceOfPrintJob(value: object): boolean {
    let isInstance = true;
...
export function PrintJobFromJSON(json: any): PrintJob {
    return PrintJobFromJSONTyped(json, false);
}

export function PrintJobFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJob {
...
export function PrintJobToJSON(value?: PrintJob | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
