...
import type { ShippingOptionsList200ResponseResultsInner } from './ShippingOptionsList200ResponseResultsInner';
import {
    ShippingOptionsList200ResponseResultsInnerFromJSON,
    ShippingOptionsList200ResponseResultsInnerFromJSONTyped,
    ShippingOptionsList200ResponseResultsInnerToJSON,
} from './ShippingOptionsList200ResponseResultsInner';

/**
 * 
 * @export
 * @interface ShippingOptionsList200Response
 */
export interface ShippingOptionsList200Response {
    /**
     * 
     * @type {number}
     * @memberof ShippingOptionsList200Response
     */
    count?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ShippingOptionsList200ResponseResultsInner>}
     * @memberof ShippingOptionsList200Response
     */
    results?: Array<ShippingOptionsList200ResponseResultsInner>;
}

/**
 * Check if a given object implements the ShippingOptionsList200Response interface.
 */
export function instanceOfShippingOptionsList200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ShippingOptionsList200ResponseFromJSON(json: any): ShippingOptionsList200Response {
    return ShippingOptionsList200ResponseFromJSONTyped(json, false);
}

export function ShippingOptionsList200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingOptionsList200Response {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(ShippingOptionsList200ResponseResultsInnerFromJSON)),
    };
}

export function ShippingOptionsList200ResponseToJSON(value?: ShippingOptionsList200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(ShippingOptionsList200ResponseResultsInnerToJSON)),
    };
}
