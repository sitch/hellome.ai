 ...
 * Shorthand of the cover source definition. If used together with 'interior' , it can replace 'printable_normalization', Alternatively to both options, a 'printable_id' of an existing printable can be provided.
 * @export
 */
export type PrintJobsList200ResponseResultsInnerItemsInnerCover = PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf | string;

export function PrintJobsList200ResponseResultsInnerItemsInnerCoverFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerCover {
    return PrintJobsList200ResponseResultsInnerItemsInnerCoverFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerCoverFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerCover {
...
export function PrintJobsList200ResponseResultsInnerItemsInnerCoverToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerCover | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
