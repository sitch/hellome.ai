 ...
 * @export
 */
export const LegacyAddressTitleEnum = {
    Mr: 'MR',
    Miss: 'MISS',
    Mrs: 'MRS',
    Ms: 'MS',
...
export type LegacyAddressTitleEnum = typeof LegacyAddressTitleEnum[keyof typeof LegacyAddressTitleEnum];


/**
 * Check if a given object implements the LegacyAddress interface.
 */
export function instanceOfLegacyAddress(value: object): boolean {
    let isInstance = true;
...
export function LegacyAddressFromJSON(json: any): LegacyAddress {
    return LegacyAddressFromJSONTyped(json, false);
}

export function LegacyAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyAddress {
...
export function LegacyAddressToJSON(value?: LegacyAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
