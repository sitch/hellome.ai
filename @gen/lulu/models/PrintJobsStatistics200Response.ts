...
/**
 * status name and the amount of corresponding print jobs
 * @export
 * @interface PrintJobsStatistics200Response
 */
export interface PrintJobsStatistics200Response {
    /**
     * Amount of printjobs
     * @type {number}
     * @memberof PrintJobsStatistics200Response
     */
     ...
     * @memberof PrintJobsStatistics200Response
     */
    status?: PrintJobsStatistics200ResponseStatusEnum;
}
 ...
 * @export
 */
export const PrintJobsStatistics200ResponseStatusEnum = {
    Created: 'CREATED',
    Rejected: 'REJECTED',
    Unpaid: 'UNPAID',
...
export type PrintJobsStatistics200ResponseStatusEnum = typeof PrintJobsStatistics200ResponseStatusEnum[keyof typeof PrintJobsStatistics200ResponseStatusEnum];


/**
 * Check if a given object implements the PrintJobsStatistics200Response interface.
 */
export function instanceOfPrintJobsStatistics200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsStatistics200ResponseFromJSON(json: any): PrintJobsStatistics200Response {
    return PrintJobsStatistics200ResponseFromJSONTyped(json, false);
}

export function PrintJobsStatistics200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsStatistics200Response {
...
export function PrintJobsStatistics200ResponseToJSON(value?: PrintJobsStatistics200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
