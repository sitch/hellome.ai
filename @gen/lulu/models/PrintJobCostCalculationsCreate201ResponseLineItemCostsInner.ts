...
import type { PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner } from './PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner';
import {
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSON,
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSONTyped,
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerToJSON,
} from './PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner';

/**
 * Costs for a Print-Job line item
 * @export
 * @interface PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
 */
export interface PrintJobCostCalculationsCreate201ResponseLineItemCostsInner {
    /**
     * Per unit cost without any discounts applied as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly cost_excl_discounts: string;
    /**
     * Discounts applied to this line item
     * @type {Array<PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner>}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly discounts: Array<PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInner>;
    /**
     * The quantity of printables to base the calculations on
     * @type {number}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly quantity: number;
    /**
     * The tax rate applied to the line as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly tax_rate: string;
    /**
     * The total line price without any discounts applied as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly total_cost_excl_discounts: string;
    /**
     * The total line price including discounts excluding tax as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly total_cost_excl_tax: string;
    /**
     * The total line price including discounts and taxes as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly total_cost_incl_tax: string;
    /**
     * The total line tax amount as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly total_tax: string;
    /**
     * Per unit cost with tier discount applied, null for list price (non-tier) customers
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201ResponseLineItemCostsInner
     */
    readonly unit_tier_cost?: string;
}

/**
 * Check if a given object implements the PrintJobCostCalculationsCreate201ResponseLineItemCostsInner interface.
 */
export function instanceOfPrintJobCostCalculationsCreate201ResponseLineItemCostsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "cost_excl_discounts" in value;
    isInstance = isInstance && "discounts" in value;
    isInstance = isInstance && "quantity" in value;
    isInstance = isInstance && "tax_rate" in value;
    isInstance = isInstance && "total_cost_excl_discounts" in value;
    isInstance = isInstance && "total_cost_excl_tax" in value;
    isInstance = isInstance && "total_cost_incl_tax" in value;
    isInstance = isInstance && "total_tax" in value;

    return isInstance;
}

export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSON(json: any): PrintJobCostCalculationsCreate201ResponseLineItemCostsInner {
    return PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreate201ResponseLineItemCostsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'cost_excl_discounts': json['cost_excl_discounts'],
        'discounts': ((json['discounts'] as Array<any>).map(PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerDiscountsInnerFromJSON)),
        'quantity': json['quantity'],
        'tax_rate': json['tax_rate'],
        'total_cost_excl_discounts': json['total_cost_excl_discounts'],
        'total_cost_excl_tax': json['total_cost_excl_tax'],
        'total_cost_incl_tax': json['total_cost_incl_tax'],
        'total_tax': json['total_tax'],
        'unit_tier_cost': !exists(json, 'unit_tier_cost') ? undefined : json['unit_tier_cost'],
    };
}

export function PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerToJSON(value?: PrintJobCostCalculationsCreate201ResponseLineItemCostsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
