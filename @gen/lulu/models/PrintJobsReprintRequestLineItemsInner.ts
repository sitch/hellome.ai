...
import type { PrintJobsReprintRequestLineItemsInnerPrintableNormalization } from './PrintJobsReprintRequestLineItemsInnerPrintableNormalization';
import {
    PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSON,
    PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSONTyped,
    PrintJobsReprintRequestLineItemsInnerPrintableNormalizationToJSON,
} from './PrintJobsReprintRequestLineItemsInnerPrintableNormalization';

/**
 * The line item of a Print-Job, defining it's printable and quantity
 * @export
 * @interface PrintJobsReprintRequestLineItemsInner
 */
export interface PrintJobsReprintRequestLineItemsInner {
    /**
     * 
     * @type {PrintJobsList200ResponseResultsInnerItemsInnerCover}
     * @memberof PrintJobsReprintRequestLineItemsInner
     */
    ...
    /**
     * 
     * @type {PrintJobsReprintRequestLineItemsInnerPrintableNormalization}
     * @memberof PrintJobsReprintRequestLineItemsInner
     */
    printable_normalization?: PrintJobsReprintRequestLineItemsInnerPrintableNormalization;
    /**
...
/**
 * Check if a given object implements the PrintJobsReprintRequestLineItemsInner interface.
 */
export function instanceOfPrintJobsReprintRequestLineItemsInner(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsReprintRequestLineItemsInnerFromJSON(json: any): PrintJobsReprintRequestLineItemsInner {
    return PrintJobsReprintRequestLineItemsInnerFromJSONTyped(json, false);
}

export function PrintJobsReprintRequestLineItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsReprintRequestLineItemsInner {
    ...
    return {
        ...
        'printable_normalization': !exists(json, 'printable_normalization') ? undefined : PrintJobsReprintRequestLineItemsInnerPrintableNormalizationFromJSON(json['printable_normalization']),
...
export function PrintJobsReprintRequestLineItemsInnerToJSON(value?: PrintJobsReprintRequestLineItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'printable_normalization': PrintJobsReprintRequestLineItemsInnerPrintableNormalizationToJSON(value.printable_normalization),
