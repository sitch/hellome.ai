 ...
 * 
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf {
    /**
     * A md5 hash of the source file to check it's integrity
     * @type {string}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf
     */
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf {
    return PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf {
...
export function PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOfToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerCoverOneOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
