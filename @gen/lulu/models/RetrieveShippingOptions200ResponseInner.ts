 ...
 * @export
 * @interface RetrieveShippingOptions200ResponseInner
 */
export interface RetrieveShippingOptions200ResponseInner {
    /**
     * Delivery only on working days
     * @type {boolean}
     * @memberof RetrieveShippingOptions200ResponseInner
     */
     ...
     * @memberof RetrieveShippingOptions200ResponseInner
     */
    readonly level: RetrieveShippingOptions200ResponseInnerLevelEnum;
    /**
 ...
 * @export
 */
export const RetrieveShippingOptions200ResponseInnerLevelEnum = {
    Mail: 'MAIL',
...
export type RetrieveShippingOptions200ResponseInnerLevelEnum = typeof RetrieveShippingOptions200ResponseInnerLevelEnum[keyof typeof RetrieveShippingOptions200ResponseInnerLevelEnum];


/**
 * Check if a given object implements the RetrieveShippingOptions200ResponseInner interface.
 */
export function instanceOfRetrieveShippingOptions200ResponseInner(value: object): boolean {
    let isInstance = true;
...
export function RetrieveShippingOptions200ResponseInnerFromJSON(json: any): RetrieveShippingOptions200ResponseInner {
    return RetrieveShippingOptions200ResponseInnerFromJSONTyped(json, false);
}

export function RetrieveShippingOptions200ResponseInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrieveShippingOptions200ResponseInner {
...
export function RetrieveShippingOptions200ResponseInnerToJSON(value?: RetrieveShippingOptions200ResponseInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
