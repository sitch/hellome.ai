...
/**
 * A map of printable normalization related messages / data
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization {
    /**
     * Array of messages related to the cover file normalization
     * @type {Array<string>}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization
     */
    cover?: Array<string>;
    /**
     * Array of messages related to the interior file normalization
     * @type {Array<string>}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization
     */
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization {
    return PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization {
    ...
    return {
        ...
        'interior': !exists(json, 'interior') ? undefined : json['interior'],
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalizationToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerStatusMessagesPrintableNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
