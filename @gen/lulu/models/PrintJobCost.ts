...
/**
 * Check if a given object implements the PrintJobCost interface.
 */
export function instanceOfPrintJobCost(value: object): boolean {
    let isInstance = true;
...
export function PrintJobCostFromJSON(json: any): PrintJobCost {
    return PrintJobCostFromJSONTyped(json, false);
}

export function PrintJobCostFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCost {
...
export function PrintJobCostToJSON(value?: PrintJobCost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
