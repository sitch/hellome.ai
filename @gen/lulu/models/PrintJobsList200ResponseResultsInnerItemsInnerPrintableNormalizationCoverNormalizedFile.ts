...
/**
 * The resulting normalized file
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile {
    /**
     * 
     * @type {number}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile
     */
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile {
    return PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'file_id': !exists(json, 'file_id') ? undefined : json['file_id'],
        'filename': !exists(json, 'filename') ? undefined : json['filename'],
    };
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFileToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverNormalizedFile | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
