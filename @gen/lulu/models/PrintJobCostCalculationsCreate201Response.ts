...
import type { PrintJobCostCalculationsCreate201ResponseLineItemCostsInner } from './PrintJobCostCalculationsCreate201ResponseLineItemCostsInner';
import {
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSON,
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSONTyped,
    PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerToJSON,
} from './PrintJobCostCalculationsCreate201ResponseLineItemCostsInner';
import type { PrintJobCostCalculationsCreate201ResponseShippingCost } from './PrintJobCostCalculationsCreate201ResponseShippingCost';
import {
    PrintJobCostCalculationsCreate201ResponseShippingCostFromJSON,
    PrintJobCostCalculationsCreate201ResponseShippingCostFromJSONTyped,
    PrintJobCostCalculationsCreate201ResponseShippingCostToJSON,
} from './PrintJobCostCalculationsCreate201ResponseShippingCost';

/**
 * Summary of the costs of a Print-Job
 * @export
 * @interface PrintJobCostCalculationsCreate201Response
 */
export interface PrintJobCostCalculationsCreate201Response {
    /**
     * Currency for the costs
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    readonly currency: string;
    /**
     * List of cost summaries for each line item
     * @type {Array<PrintJobCostCalculationsCreate201ResponseLineItemCostsInner>}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    readonly line_item_costs: Array<PrintJobCostCalculationsCreate201ResponseLineItemCostsInner>;
    /**
     * 
     * @type {PrintJobCostCalculationsCreate201ResponseShippingCost}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    shipping_cost: PrintJobCostCalculationsCreate201ResponseShippingCost;
    /**
     * Total costs of the job excluding taxes as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    readonly total_cost_excl_tax: string;
    /**
     * Total costs of the job including taxes as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    readonly total_cost_incl_tax: string;
    /**
     * The total discount amount as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
    readonly total_discount_amount: string;
    /**
     * Total amount of taxes on the job as a decimal string
     * @type {string}
     * @memberof PrintJobCostCalculationsCreate201Response
     */
...
/**
 * Check if a given object implements the PrintJobCostCalculationsCreate201Response interface.
 */
export function instanceOfPrintJobCostCalculationsCreate201Response(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "currency" in value;
    isInstance = isInstance && "line_item_costs" in value;
    isInstance = isInstance && "shipping_cost" in value;
    isInstance = isInstance && "total_cost_excl_tax" in value;
    isInstance = isInstance && "total_cost_incl_tax" in value;
    isInstance = isInstance && "total_discount_amount" in value;
    isInstance = isInstance && "total_tax" in value;

    return isInstance;
}

export function PrintJobCostCalculationsCreate201ResponseFromJSON(json: any): PrintJobCostCalculationsCreate201Response {
    return PrintJobCostCalculationsCreate201ResponseFromJSONTyped(json, false);
}

export function PrintJobCostCalculationsCreate201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobCostCalculationsCreate201Response {
    ...
    return {
        ...
        'line_item_costs': ((json['line_item_costs'] as Array<any>).map(PrintJobCostCalculationsCreate201ResponseLineItemCostsInnerFromJSON)),
        'shipping_cost': PrintJobCostCalculationsCreate201ResponseShippingCostFromJSON(json['shipping_cost']),
        'total_cost_excl_tax': json['total_cost_excl_tax'],
        'total_cost_incl_tax': json['total_cost_incl_tax'],
        'total_discount_amount': json['total_discount_amount'],
        'total_tax': json['total_tax'],
    };
}

export function PrintJobCostCalculationsCreate201ResponseToJSON(value?: PrintJobCostCalculationsCreate201Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'shipping_cost': PrintJobCostCalculationsCreate201ResponseShippingCostToJSON(value.shipping_cost),
    };
}
