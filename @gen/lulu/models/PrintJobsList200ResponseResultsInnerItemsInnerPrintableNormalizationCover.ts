...
/**
 * Represents the normalization process of the cover source files
 * @export
 * @interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover
 */
export interface PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover {
    /**
     * The id of the normalization job (either a InteriorNormalizationJob or a CoverNormalizationJob)
     * @type {number}
     * @memberof PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover
     */
    job_id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover interface.
 */
export function instanceOfPrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover(value: object): boolean {
    let isInstance = true;
...
export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSON(json: any): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover {
    return PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSONTyped(json, false);
}

export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover {
...
export function PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCoverToJSON(value?: PrintJobsList200ResponseResultsInnerItemsInnerPrintableNormalizationCover | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
