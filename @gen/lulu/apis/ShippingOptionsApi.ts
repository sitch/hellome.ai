...
import type {
  Forbidden,
  RetrieveShippingOptions200ResponseInner,
  RetrieveShippingOptionsRequest,
  ShippingOptionsList200Response,
  Unauthorized,
} from '../models';
import {
    ForbiddenFromJSON,
    ForbiddenToJSON,
    RetrieveShippingOptions200ResponseInnerFromJSON,
    RetrieveShippingOptions200ResponseInnerToJSON,
    RetrieveShippingOptionsRequestFromJSON,
    RetrieveShippingOptionsRequestToJSON,
    ShippingOptionsList200ResponseFromJSON,
    ShippingOptionsList200ResponseToJSON,
    UnauthorizedFromJSON,
    UnauthorizedToJSON,
} from '../models';

export interface RetrieveShippingOptionsOperationRequest {
    retrieve_shipping_options_request?: RetrieveShippingOptionsRequest;
}

export interface ShippingOptionsListRequest {
    page?: number;
    page_size?: number;
    currency?: string;
    quantity?: string;
    ...
    state_code?: string;
    level?: ShippingOptionsListLevelEnum;
    postbox_ok?: boolean;
 ...
 * 
 */
export class ShippingOptionsApi extends runtime.BaseAPI {

    /**
     * When integrating the Print API with your own shop, you might want to give customers an option to select among different shipping levels. This endpoint allows you to request available shipping methods (including cost) with minimal input data: * `country` * `page_count` * `quantity` * `pod_package_id` * `currency` only required if you don\'t want USD  You can further restrict shipping options that support post box delivery by adding `is_postbox=true` to your shipping address data. 
     * Retrieve List of Shipping Options
     */
    async retrieveShippingOptionsRaw(requestParameters: RetrieveShippingOptionsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<RetrieveShippingOptions200ResponseInner>>> {
        ...
        const response = await this.request({
            ...
            body: RetrieveShippingOptionsRequestToJSON(requestParameters.retrieve_shipping_options_request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(RetrieveShippingOptions200ResponseInnerFromJSON));
    }
     ...
     * Retrieve List of Shipping Options
     */
    async retrieveShippingOptions(requestParameters: RetrieveShippingOptionsOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<RetrieveShippingOptions200ResponseInner>> {
        const response = await this.retrieveShippingOptionsRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * This endpoint will be fully deprecated on 30th April 2023, use <a href=\"#operation/retrieve-shipping-options\" target=\"_blank\">shipping-options</a> instead.</br> When integrating the Print API with your own shop, you might want to give customers an option to select among different shipping_levels. This endpoint allows you to request available shipping methods (including cost) with minimal input data. Typically you want to specify the following parameters in a query: * `iso_country_code` * `fastest_per_level` * `quantity` * `pod_package_id` * `currency` only required if you don\'t want USD  You can further restrict shipping options that support post box delivery by adding `postbox_ok=true` to your query. 
     * Retrieve List of Shipping Options
     */
    async shippingOptionsListRaw(requestParameters: ShippingOptionsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShippingOptionsList200Response>> {
        const queryParameters: any = {};
        ...
        if (requestParameters.pod_package_id !== undefined) {
            queryParameters['pod_package_id'] = requestParameters.pod_package_id;
        }

        if (requestParameters.iso_country_code !== undefined) {
            queryParameters['iso_country_code'] = requestParameters.iso_country_code;
        }

        if (requestParameters.state_code !== undefined) {
            queryParameters['state_code'] = requestParameters.state_code;
        }
        ...
        if (requestParameters.postbox_ok !== undefined) {
            queryParameters['postbox_ok'] = requestParameters.postbox_ok;
        }

        if (requestParameters.fastest_per_level !== undefined) {
            queryParameters['fastest_per_level'] = requestParameters.fastest_per_level;
        }
        ...
        const response = await this.request({
            path: `/print-shipping-options/`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShippingOptionsList200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve List of Shipping Options
     */
    async shippingOptionsList(requestParameters: ShippingOptionsListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShippingOptionsList200Response> {
        const response = await this.shippingOptionsListRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const ShippingOptionsListLevelEnum = {
    Mail: 'MAIL',
...
export type ShippingOptionsListLevelEnum = typeof ShippingOptionsListLevelEnum[keyof typeof ShippingOptionsListLevelEnum];
