...
import type {
  Forbidden,
  PrintJobCostCalculationsCreate201Response,
  PrintJobCostCalculationsCreateRequest,
  Unauthorized,
} from '../models';
import {
    ForbiddenFromJSON,
    ForbiddenToJSON,
    PrintJobCostCalculationsCreate201ResponseFromJSON,
    PrintJobCostCalculationsCreate201ResponseToJSON,
    PrintJobCostCalculationsCreateRequestFromJSON,
    PrintJobCostCalculationsCreateRequestToJSON,
    UnauthorizedFromJSON,
    UnauthorizedToJSON,
} from '../models';

export interface PrintJobCostCalculationsCreateOperationRequest {
    print_job_cost_calculations_create_request?: PrintJobCostCalculationsCreateRequest;
}

/**
 * 
 */
export class PrintJobCostCalculationsApi extends runtime.BaseAPI {
     ...
     */
    async printJobCostCalculationsCreateRaw(requestParameters: PrintJobCostCalculationsCreateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PrintJobCostCalculationsCreate201Response>> {
        ...
        const response = await this.request({
            ...
            body: PrintJobCostCalculationsCreateRequestToJSON(requestParameters.print_job_cost_calculations_create_request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PrintJobCostCalculationsCreate201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a Print-Job cost calculation
     */
    async printJobCostCalculationsCreate(requestParameters: PrintJobCostCalculationsCreateOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PrintJobCostCalculationsCreate201Response> {
        const response = await this.printJobCostCalculationsCreateRaw(requestParameters, initOverrides);
