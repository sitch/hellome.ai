...
import { ConceptTensorUpdateManyWithoutPredictionNestedInputSchema } from './ConceptTensorUpdateManyWithoutPredictionNestedInputSchema';

export const DreamBoothPredictionUpdateInputSchema: z.ZodType<Prisma.DreamBoothPredictionUpdateInput> = z.object({
  ...
  ConceptTensor: z.lazy(() => ConceptTensorUpdateManyWithoutPredictionNestedInputSchema).optional()
}).strict();

export default DreamBoothPredictionUpdateInputSchema;
