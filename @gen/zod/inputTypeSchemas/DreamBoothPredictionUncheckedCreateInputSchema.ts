...
import { ConceptTensorUncheckedCreateNestedManyWithoutPredictionInputSchema } from './ConceptTensorUncheckedCreateNestedManyWithoutPredictionInputSchema';

export const DreamBoothPredictionUncheckedCreateInputSchema: z.ZodType<Prisma.DreamBoothPredictionUncheckedCreateInput> = z.object({
  ...
  ConceptTensor: z.lazy(() => ConceptTensorUncheckedCreateNestedManyWithoutPredictionInputSchema).optional()
}).strict();

export default DreamBoothPredictionUncheckedCreateInputSchema;
