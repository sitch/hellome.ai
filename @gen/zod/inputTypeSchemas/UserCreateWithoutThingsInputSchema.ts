...
export const UserCreateWithoutThingsInputSchema: z.ZodType<Prisma.UserCreateWithoutThingsInput> = z.object({
...
export default UserCreateWithoutThingsInputSchema;
