...
export const FamilyCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.FamilyCreateNestedManyWithoutUserInput> = z.object({
...
export default FamilyCreateNestedManyWithoutUserInputSchema;
