...
export const ConceptPersonUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.ConceptPersonUpdateOneWithoutUserNestedInput> = z.object({
...
export default ConceptPersonUpdateOneWithoutUserNestedInputSchema;
