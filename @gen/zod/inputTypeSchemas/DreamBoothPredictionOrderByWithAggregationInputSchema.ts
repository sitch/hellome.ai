...
import { DreamBoothPredictionCountOrderByAggregateInputSchema } from './DreamBoothPredictionCountOrderByAggregateInputSchema';
import { DreamBoothPredictionAvgOrderByAggregateInputSchema } from './DreamBoothPredictionAvgOrderByAggregateInputSchema';
import { DreamBoothPredictionMaxOrderByAggregateInputSchema } from './DreamBoothPredictionMaxOrderByAggregateInputSchema';
import { DreamBoothPredictionMinOrderByAggregateInputSchema } from './DreamBoothPredictionMinOrderByAggregateInputSchema';
import { DreamBoothPredictionSumOrderByAggregateInputSchema } from './DreamBoothPredictionSumOrderByAggregateInputSchema';

export const DreamBoothPredictionOrderByWithAggregationInputSchema: z.ZodType<Prisma.DreamBoothPredictionOrderByWithAggregationInput> = z.object({
  ...
  _count: z.lazy(() => DreamBoothPredictionCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => DreamBoothPredictionAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => DreamBoothPredictionMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => DreamBoothPredictionMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => DreamBoothPredictionSumOrderByAggregateInputSchema).optional()
}).strict();

export default DreamBoothPredictionOrderByWithAggregationInputSchema;
