...
import { ConceptTensorOrderByRelationAggregateInputSchema } from './ConceptTensorOrderByRelationAggregateInputSchema';

export const DreamBoothPredictionOrderByWithRelationInputSchema: z.ZodType<Prisma.DreamBoothPredictionOrderByWithRelationInput> = z.object({
  ...
  ConceptTensor: z.lazy(() => ConceptTensorOrderByRelationAggregateInputSchema).optional()
}).strict();

export default DreamBoothPredictionOrderByWithRelationInputSchema;
