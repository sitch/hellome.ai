...
export const ConceptPlaceUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.ConceptPlaceUncheckedCreateNestedManyWithoutUserInput> = z.object({
...
export default ConceptPlaceUncheckedCreateNestedManyWithoutUserInputSchema;
