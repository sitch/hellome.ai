...
export const ConceptTensorMinOrderByAggregateInputSchema: z.ZodType<Prisma.ConceptTensorMinOrderByAggregateInput> = z.object({
...
export default ConceptTensorMinOrderByAggregateInputSchema;
