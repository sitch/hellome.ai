...
export const DreamBoothPredictionCreateArgsSchema: z.ZodType<Prisma.DreamBoothPredictionCreateArgs> = z.object({
  select: DreamBoothPredictionSelectSchema.optional(),
  include: DreamBoothPredictionIncludeSchema.optional(),
  data: z.union([ DreamBoothPredictionCreateInputSchema,DreamBoothPredictionUncheckedCreateInputSchema ]),
}).strict()

export default DreamBoothPredictionCreateArgsSchema;
