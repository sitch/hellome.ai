...
export const ConceptThingCreateArgsSchema: z.ZodType<Prisma.ConceptThingCreateArgs> = z.object({
  select: ConceptThingSelectSchema.optional(),
  include: ConceptThingIncludeSchema.optional(),
  data: z.union([ ConceptThingCreateInputSchema,ConceptThingUncheckedCreateInputSchema ]),
}).strict()

export default ConceptThingCreateArgsSchema;
