...
export const ConceptPlaceCreateArgsSchema: z.ZodType<Prisma.ConceptPlaceCreateArgs> = z.object({
  select: ConceptPlaceSelectSchema.optional(),
  include: ConceptPlaceIncludeSchema.optional(),
  data: z.union([ ConceptPlaceCreateInputSchema,ConceptPlaceUncheckedCreateInputSchema ]),
}).strict()

export default ConceptPlaceCreateArgsSchema;
