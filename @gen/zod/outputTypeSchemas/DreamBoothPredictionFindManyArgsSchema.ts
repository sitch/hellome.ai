...
export const DreamBoothPredictionFindManyArgsSchema: z.ZodType<Prisma.DreamBoothPredictionFindManyArgs> = z.object({
...
export default DreamBoothPredictionFindManyArgsSchema;
