...
export const UserStoryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.UserStoryFindUniqueOrThrowArgs> = z.object({
  select: UserStorySelectSchema.optional(),
  include: UserStoryIncludeSchema.optional(),
  where: UserStoryWhereUniqueInputSchema,
}).strict()

export default UserStoryFindUniqueOrThrowArgsSchema;
