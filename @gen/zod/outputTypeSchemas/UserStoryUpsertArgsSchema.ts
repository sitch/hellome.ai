...
export const UserStoryUpsertArgsSchema: z.ZodType<Prisma.UserStoryUpsertArgs> = z.object({
  select: UserStorySelectSchema.optional(),
  include: UserStoryIncludeSchema.optional(),
  where: UserStoryWhereUniqueInputSchema,
  create: z.union([ UserStoryCreateInputSchema,UserStoryUncheckedCreateInputSchema ]),
  update: z.union([ UserStoryUpdateInputSchema,UserStoryUncheckedUpdateInputSchema ]),
}).strict()

export default UserStoryUpsertArgsSchema;
