...
export const FaceMeshUpdateArgsSchema: z.ZodType<Prisma.FaceMeshUpdateArgs> = z.object({
  select: FaceMeshSelectSchema.optional(),
  include: FaceMeshIncludeSchema.optional(),
  data: z.union([ FaceMeshUpdateInputSchema,FaceMeshUncheckedUpdateInputSchema ]),
  where: FaceMeshWhereUniqueInputSchema,
}).strict()

export default FaceMeshUpdateArgsSchema;
