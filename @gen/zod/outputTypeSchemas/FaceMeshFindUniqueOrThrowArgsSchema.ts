...
export const FaceMeshFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.FaceMeshFindUniqueOrThrowArgs> = z.object({
  select: FaceMeshSelectSchema.optional(),
  include: FaceMeshIncludeSchema.optional(),
  where: FaceMeshWhereUniqueInputSchema,
}).strict()

export default FaceMeshFindUniqueOrThrowArgsSchema;
