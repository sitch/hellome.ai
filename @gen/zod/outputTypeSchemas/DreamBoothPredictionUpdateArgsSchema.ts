...
export const DreamBoothPredictionUpdateArgsSchema: z.ZodType<Prisma.DreamBoothPredictionUpdateArgs> = z.object({
  select: DreamBoothPredictionSelectSchema.optional(),
  include: DreamBoothPredictionIncludeSchema.optional(),
  data: z.union([ DreamBoothPredictionUpdateInputSchema,DreamBoothPredictionUncheckedUpdateInputSchema ]),
  where: DreamBoothPredictionWhereUniqueInputSchema,
}).strict()

export default DreamBoothPredictionUpdateArgsSchema;
