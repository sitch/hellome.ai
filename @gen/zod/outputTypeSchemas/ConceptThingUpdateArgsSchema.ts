...
export const ConceptThingUpdateArgsSchema: z.ZodType<Prisma.ConceptThingUpdateArgs> = z.object({
  select: ConceptThingSelectSchema.optional(),
  include: ConceptThingIncludeSchema.optional(),
  data: z.union([ ConceptThingUpdateInputSchema,ConceptThingUncheckedUpdateInputSchema ]),
  where: ConceptThingWhereUniqueInputSchema,
}).strict()

export default ConceptThingUpdateArgsSchema;
