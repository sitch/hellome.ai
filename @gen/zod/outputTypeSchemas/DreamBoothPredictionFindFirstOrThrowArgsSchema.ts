...
export const DreamBoothPredictionFindFirstOrThrowArgsSchema: z.ZodType<Prisma.DreamBoothPredictionFindFirstOrThrowArgs> = z.object({
  ...
  distinct: DreamBoothPredictionScalarFieldEnumSchema.array().optional(),
}).strict()

export default DreamBoothPredictionFindFirstOrThrowArgsSchema;
